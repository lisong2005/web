...
public class DruidPooledPreparedStatement extends DruidPooledStatement implements PreparedStatement {
    ...
    private final static Log              LOG    = LogFactory
                                                     .getLog(DruidPooledPreparedStatement.class);
    ...
    public DruidPooledPreparedStatement(DruidPooledConnection conn, PreparedStatementHolder holder)
                                                                                                   throws SQLException {
    ...
    public static class PreparedStatementKey {
        ...
        public PreparedStatementKey(String sql, String catalog, MethodType methodType,
            ...
            this(sql, catalog, methodType, resultSetType, resultSetConcurrency,
                resultSetHoldability, 0, null, null);
        }
