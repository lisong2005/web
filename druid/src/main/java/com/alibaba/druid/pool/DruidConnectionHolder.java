...
public final class DruidConnectionHolder {
    ...
    private final static Log                    LOG                      = LogFactory
                                                                             .getLog(DruidConnectionHolder.class);
    ...
    public DruidConnectionHolder(DruidAbstractDataSource dataSource,
                                 PhysicalConnectionInfo pyConnectInfo) throws SQLException {
    ...
    public DruidConnectionHolder(DruidAbstractDataSource dataSource, Connection conn,
                                 long connectNanoSpan) throws SQLException {
        ...
        try {
            ...
            if (!"com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException".equals(e.getClass()
                .getName())) {
                throw e;
            }
        }
