...
public abstract class DruidAbstractDataSource extends WrapperAdapter implements
    ...
    public void validateConnection(Connection conn) throws SQLException {
        ...
        if (validConnectionChecker != null) {
            if (!validConnectionChecker.isValidConnection(conn, validationQuery,
    ...
    protected boolean testConnectionInternal(Connection conn) {
        ...
        try {
            if (validConnectionChecker != null) {
                return validConnectionChecker.isValidConnection(conn, validationQuery,
                    validationQueryTimeout);
            }
    ...
    public PhysicalConnectionInfo createPhysicalConnection() throws SQLException {
        ...
        return new PhysicalConnectionInfo(conn, connectStartNanos, connectedNanos, initedNanos,
            validatedNanos);
    }
