...
public class MySqlMockExecuteHandlerImpl implements MockExecuteHandler {
    ...
    public ResultSet executeQuery(MockStatementBase statement, SQLSelectQueryBlock query)
                                                                                         throws SQLException {
    ...
    public ResultSet executeQueryFromDual(MockStatementBase statement, SQLSelectQueryBlock query)
                                                                                                 throws SQLException {
