...
public class EncodingConvertFilter extends FilterAdapter {
    ...
    public ConnectionProxy connection_connect(FilterChain chain, Properties info)
        ...
        conn.putAttribute(ATTR_CHARSET_CONVERTER, new CharsetConvert(param.getClientEncoding(),
            param.getServerEncoding()));
    ...
    public String encode(ConnectionProxy connection, String s) throws SQLException {
        try {
            CharsetConvert charsetConvert = (CharsetConvert) connection
                .getAttribute(ATTR_CHARSET_CONVERTER);
    ...
    public boolean statement_execute(FilterChain chain, StatementProxy statement, String sql)
                                                                                             throws SQLException {
        return super.statement_execute(chain, statement,
            encode(statement.getConnectionProxy(), sql));
    }
    ...
    public boolean statement_execute(FilterChain chain, StatementProxy statement, String sql,
        ...
        return super.statement_execute(chain, statement,
            encode(statement.getConnectionProxy(), sql), autoGeneratedKeys);
    }
    ...
    public boolean statement_execute(FilterChain chain, StatementProxy statement, String sql,
        ...
        return super.statement_execute(chain, statement,
            encode(statement.getConnectionProxy(), sql), columnIndexes);
    }
    ...
    public boolean statement_execute(FilterChain chain, StatementProxy statement, String sql,
        ...
        return super.statement_execute(chain, statement,
            encode(statement.getConnectionProxy(), sql), columnNames);
    }

    @Override
    public ResultSetProxy statement_executeQuery(FilterChain chain, StatementProxy statement,
                                                 String sql) throws SQLException {
        return super.statement_executeQuery(chain, statement,
            encode(statement.getConnectionProxy(), sql));
    }
    ...
    public int statement_executeUpdate(FilterChain chain, StatementProxy statement, String sql)
                                                                                               throws SQLException {
        return super.statement_executeUpdate(chain, statement,
            encode(statement.getConnectionProxy(), sql));
    }
    ...
    public void preparedStatement_setString(FilterChain chain, PreparedStatementProxy statement,
        ...
        super.preparedStatement_setString(chain, statement, parameterIndex,
            encode(statement.getConnectionProxy(), x));
    }
    ...
    public void preparedStatement_setCharacterStream(FilterChain chain,
        ...
        super.preparedStatement_setCharacterStream(chain, statement, parameterIndex,
    ...
    public void preparedStatement_setCharacterStream(FilterChain chain,
        ...
        String encodedText = encode(statement.getConnectionProxy(), text);
        super.preparedStatement_setCharacterStream(chain, statement, parameterIndex,
            new StringReader(encodedText), encodedText.length());
    }
    ...
    public void preparedStatement_setObject(FilterChain chain, PreparedStatementProxy statement,
        ...
        if (x instanceof String) {
            ...
            String encodedText = encode(statement.getConnectionProxy(), text);
            super.preparedStatement_setObject(chain, statement, parameterIndex, new StringReader(
                encodedText));
        } else {
    ...
    public void preparedStatement_setObject(FilterChain chain, PreparedStatementProxy statement,
        ...
        if (x instanceof String) {
            ...
            String encodedText = encode(statement.getConnectionProxy(), text);
            super.preparedStatement_setObject(chain, statement, parameterIndex, new StringReader(
                encodedText), targetSqlType, scaleOrLength);
        } else {
            super.preparedStatement_setObject(chain, statement, parameterIndex, x, targetSqlType,
                scaleOrLength);
        }
    ...
    public long clob_position(FilterChain chain, ClobProxy wrapper, String searchstr, long start)
                                                                                                 throws SQLException {
        return chain.clob_position(wrapper, encode(wrapper.getConnectionWrapper(), searchstr),
            start);
    }
    ...
    public void callableStatement_setString(FilterChain chain, CallableStatementProxy statement,
        ...
        super.callableStatement_setString(chain, statement, parameterName,
            encode(statement.getConnectionProxy(), x));
    }
    ...
    public void callableStatement_setObject(FilterChain chain, CallableStatementProxy statement,
        ...
        if (x instanceof String) {
            ...
            String text = Utils.read((Reader) x);
            String encodedText = encode(statement.getConnectionProxy(), text);
            super.callableStatement_setObject(chain, statement, parameterName, new StringReader(
                encodedText));
        } else {
    ...
    public void callableStatement_setObject(FilterChain chain, CallableStatementProxy statement,
        ...
        if (x instanceof String) {
            ...
            String encodedText = encode(statement.getConnectionProxy(), text);
            super.callableStatement_setObject(chain, statement, parameterName, new StringReader(
                encodedText), targetSqlType, scale);
        } else {
            super.callableStatement_setObject(chain, statement, parameterName, x, targetSqlType,
                scale);
        }
