...
public class FilterChainImpl implements FilterChain {
    ...
    @Override
    public Array connection_createArrayOf(ConnectionProxy connection, String typeName,
    ...
    public StatementProxy connection_createStatement(ConnectionProxy connection, int resultSetType,
        ...
        if (this.pos < filterSize) {
            return nextFilter().connection_createStatement(this, connection, resultSetType,
                resultSetConcurrency);
        }

        Statement statement = connection.getRawObject().createStatement(resultSetType,
            resultSetConcurrency);
        return wrap(connection, statement);
    }
    ...
    @Override
    public Struct connection_createStruct(ConnectionProxy connection, String typeName,
    ...
    @Override
    public String connection_getClientInfo(ConnectionProxy connection, String name)
                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public CallableStatementProxy connection_prepareCall(ConnectionProxy connection, String sql)
                                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    public CallableStatementProxy connection_prepareCall(ConnectionProxy connection, String sql,
                                                         int resultSetType, int resultSetConcurrency)
                                                                                                     throws SQLException {
        if (this.pos < filterSize) {
            return nextFilter().connection_prepareCall(this, connection, sql, resultSetType,
                resultSetConcurrency);
        }
    ...
    public PreparedStatementProxy connection_prepareStatement(ConnectionProxy connection,
                                                              ...
                                                              int resultSetConcurrency)
                                                                                       throws SQLException {
        if (this.pos < filterSize) {
            return nextFilter().connection_prepareStatement(this, connection, sql, resultSetType,
                resultSetConcurrency);
        }
    ...
    @Override
    public void connection_releaseSavepoint(ConnectionProxy connection, Savepoint savepoint)
                                                                                            throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void connection_rollback(ConnectionProxy connection, Savepoint savepoint)
                                                                                    throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void connection_setAutoCommit(ConnectionProxy connection, boolean autoCommit)
                                                                                        throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void connection_setCatalog(ConnectionProxy connection, String catalog)
                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void connection_setHoldability(ConnectionProxy connection, int holdability)
                                                                                      throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void connection_setReadOnly(ConnectionProxy connection, boolean readOnly)
                                                                                    throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Savepoint connection_setSavepoint(ConnectionProxy connection, String name)
                                                                                     throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void connection_setTransactionIsolation(ConnectionProxy connection, int level)
                                                                                         throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void connection_setTypeMap(ConnectionProxy connection, Map<String, Class<?>> map)
                                                                                            throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public String resultSet_getString(ResultSetProxy resultSet, int columnIndex)
                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean resultSet_getBoolean(ResultSetProxy resultSet, int columnIndex)
                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public double resultSet_getDouble(ResultSetProxy resultSet, int columnIndex)
                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public BigDecimal resultSet_getBigDecimal(ResultSetProxy resultSet, int columnIndex, int scale)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.sql.Date resultSet_getDate(ResultSetProxy resultSet, int columnIndex)
                                                                                     throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.sql.Time resultSet_getTime(ResultSetProxy resultSet, int columnIndex)
                                                                                     throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.sql.Timestamp resultSet_getTimestamp(ResultSetProxy resultSet, int columnIndex)
                                                                                               throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.io.InputStream resultSet_getAsciiStream(ResultSetProxy resultSet, int columnIndex)
                                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.io.InputStream resultSet_getBinaryStream(ResultSetProxy resultSet, int columnIndex)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public String resultSet_getString(ResultSetProxy resultSet, String columnLabel)
                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean resultSet_getBoolean(ResultSetProxy resultSet, String columnLabel)
                                                                                     throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public short resultSet_getShort(ResultSetProxy resultSet, String columnLabel)
                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public float resultSet_getFloat(ResultSetProxy resultSet, String columnLabel)
                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public double resultSet_getDouble(ResultSetProxy resultSet, String columnLabel)
                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @SuppressWarnings("deprecation")
    @Override
    public BigDecimal resultSet_getBigDecimal(ResultSetProxy resultSet, String columnLabel,
    ...
    @Override
    public byte[] resultSet_getBytes(ResultSetProxy resultSet, String columnLabel)
                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.sql.Date resultSet_getDate(ResultSetProxy resultSet, String columnLabel)
                                                                                        throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.sql.Time resultSet_getTime(ResultSetProxy resultSet, String columnLabel)
                                                                                        throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.sql.Timestamp resultSet_getTimestamp(ResultSetProxy resultSet, String columnLabel)
                                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @SuppressWarnings("deprecation")
    @Override
    public java.io.InputStream resultSet_getUnicodeStream(ResultSetProxy resultSet,
    ...
    @Override
    public java.io.InputStream resultSet_getBinaryStream(ResultSetProxy resultSet,
                                                         String columnLabel) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Object resultSet_getObject(ResultSetProxy resultSet, int columnIndex)
                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Object resultSet_getObject(ResultSetProxy resultSet, String columnLabel)
                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public int resultSet_findColumn(ResultSetProxy resultSet, String columnLabel)
                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.io.Reader resultSet_getCharacterStream(ResultSetProxy resultSet, int columnIndex)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public BigDecimal resultSet_getBigDecimal(ResultSetProxy resultSet, int columnIndex)
                                                                                        throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_setFetchDirection(ResultSetProxy resultSet, int direction)
                                                                                    throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateBoolean(ResultSetProxy resultSet, int columnIndex, boolean x)
                                                                                             throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateByte(ResultSetProxy resultSet, int columnIndex, byte x)
                                                                                       throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateShort(ResultSetProxy resultSet, int columnIndex, short x)
                                                                                         throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateInt(ResultSetProxy resultSet, int columnIndex, int x)
                                                                                     throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateLong(ResultSetProxy resultSet, int columnIndex, long x)
                                                                                       throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateFloat(ResultSetProxy resultSet, int columnIndex, float x)
                                                                                         throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateDouble(ResultSetProxy resultSet, int columnIndex, double x)
                                                                                           throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateBigDecimal(ResultSetProxy resultSet, int columnIndex, BigDecimal x)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateString(ResultSetProxy resultSet, int columnIndex, String x)
                                                                                           throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateBytes(ResultSetProxy resultSet, int columnIndex, byte[] x)
                                                                                          throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateDate(ResultSetProxy resultSet, int columnIndex, java.sql.Date x)
                                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateTime(ResultSetProxy resultSet, int columnIndex, java.sql.Time x)
                                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateTimestamp(ResultSetProxy resultSet, int columnIndex,
    ...
    @Override
    public void resultSet_updateAsciiStream(ResultSetProxy resultSet, int columnIndex,
    ...
    @Override
    public void resultSet_updateBinaryStream(ResultSetProxy resultSet, int columnIndex,
                                             java.io.InputStream x, int length) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateCharacterStream(ResultSetProxy resultSet, int columnIndex,
    ...
    @Override
    public void resultSet_updateObject(ResultSetProxy resultSet, int columnIndex, Object x,
    ...
    @Override
    public void resultSet_updateNull(ResultSetProxy resultSet, String columnLabel)
                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateBoolean(ResultSetProxy resultSet, String columnLabel, boolean x)
                                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateByte(ResultSetProxy resultSet, String columnLabel, byte x)
                                                                                          throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateShort(ResultSetProxy resultSet, String columnLabel, short x)
                                                                                            throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateInt(ResultSetProxy resultSet, String columnLabel, int x)
                                                                                        throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateLong(ResultSetProxy resultSet, String columnLabel, long x)
                                                                                          throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateFloat(ResultSetProxy resultSet, String columnLabel, float x)
                                                                                            throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateDouble(ResultSetProxy resultSet, String columnLabel, double x)
                                                                                              throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateBigDecimal(ResultSetProxy resultSet, String columnLabel,
    ...
    @Override
    public void resultSet_updateString(ResultSetProxy resultSet, String columnLabel, String x)
                                                                                              throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateBytes(ResultSetProxy resultSet, String columnLabel, byte x[])
                                                                                             throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateDate(ResultSetProxy resultSet, String columnLabel, java.sql.Date x)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateTime(ResultSetProxy resultSet, String columnLabel, java.sql.Time x)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateTimestamp(ResultSetProxy resultSet, String columnLabel,
                                          java.sql.Timestamp x) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateAsciiStream(ResultSetProxy resultSet, String columnLabel,
                                            java.io.InputStream x, int length) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateBinaryStream(ResultSetProxy resultSet, String columnLabel,
                                             java.io.InputStream x, int length) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateCharacterStream(ResultSetProxy resultSet, String columnLabel,
    ...
    @Override
    public void resultSet_updateObject(ResultSetProxy resultSet, String columnLabel, Object x,
                                       int scaleOrLength) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Array resultSet_getArray(ResultSetProxy resultSet, String columnLabel)
                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.sql.Date resultSet_getDate(ResultSetProxy resultSet, int columnIndex, Calendar cal)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.sql.Time resultSet_getTime(ResultSetProxy resultSet, int columnIndex, Calendar cal)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.net.URL resultSet_getURL(ResultSetProxy resultSet, int columnIndex)
                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.net.URL resultSet_getURL(ResultSetProxy resultSet, String columnLabel)
                                                                                      throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateRef(ResultSetProxy resultSet, int columnIndex, java.sql.Ref x)
                                                                                              throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateRef(ResultSetProxy resultSet, String columnLabel, java.sql.Ref x)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateBlob(ResultSetProxy resultSet, int columnIndex, java.sql.Blob x)
                                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateBlob(ResultSetProxy resultSet, String columnLabel, java.sql.Blob x)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateClob(ResultSetProxy resultSet, int columnIndex, java.sql.Clob x)
                                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateClob(ResultSetProxy resultSet, String columnLabel, java.sql.Clob x)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateArray(ResultSetProxy resultSet, int columnIndex, java.sql.Array x)
                                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public RowId resultSet_getRowId(ResultSetProxy resultSet, String columnLabel)
                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateRowId(ResultSetProxy resultSet, int columnIndex, RowId x)
                                                                                         throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateRowId(ResultSetProxy resultSet, String columnLabel, RowId x)
                                                                                            throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateNString(ResultSetProxy resultSet, int columnIndex, String nString)
                                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateNClob(ResultSetProxy resultSet, int columnIndex, NClob nClob)
                                                                                             throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateNClob(ResultSetProxy resultSet, String columnLabel, NClob nClob)
                                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public NClob resultSet_getNClob(ResultSetProxy resultSet, String columnLabel)
                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public SQLXML resultSet_getSQLXML(ResultSetProxy resultSet, int columnIndex)
                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public SQLXML resultSet_getSQLXML(ResultSetProxy resultSet, String columnLabel)
                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateSQLXML(ResultSetProxy resultSet, int columnIndex, SQLXML xmlObject)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateSQLXML(ResultSetProxy resultSet, String columnLabel,
    ...
    @Override
    public String resultSet_getNString(ResultSetProxy resultSet, int columnIndex)
                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public String resultSet_getNString(ResultSetProxy resultSet, String columnLabel)
                                                                                    throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.io.Reader resultSet_getNCharacterStream(ResultSetProxy resultSet, int columnIndex)
                                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateNCharacterStream(ResultSetProxy resultSet, int columnIndex,
    ...
    @Override
    public void resultSet_updateNCharacterStream(ResultSetProxy resultSet, String columnLabel,
    ...
    @Override
    public void resultSet_updateBlob(ResultSetProxy resultSet, int columnIndex,
    ...
    @Override
    public void resultSet_updateBlob(ResultSetProxy resultSet, String columnLabel,
                                     InputStream inputStream, long length) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateClob(ResultSetProxy resultSet, int columnIndex, Reader reader,
    ...
    @Override
    public void resultSet_updateClob(ResultSetProxy resultSet, String columnLabel, Reader reader,
                                     long length) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateNClob(ResultSetProxy resultSet, int columnIndex, Reader reader,
                                      long length) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void resultSet_updateNClob(ResultSetProxy resultSet, String columnLabel, Reader reader,
                                      long length) throws SQLException {
        if (this.pos < filterSize) {
    ...
    // //////////////////////////////////////// statement
    @Override
    public ResultSetProxy statement_executeQuery(StatementProxy statement, String sql)
                                                                                      throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void statement_setEscapeProcessing(StatementProxy statement, boolean enable)
                                                                                       throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void statement_setQueryTimeout(StatementProxy statement, int seconds)
                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void statement_setFetchDirection(StatementProxy statement, int direction)
                                                                                    throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean statement_getMoreResults(StatementProxy statement, int current)
                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void statement_setPoolable(StatementProxy statement, boolean poolable)
                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void preparedStatement_setNull(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setBoolean(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setByte(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setShort(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setLong(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setFloat(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setDouble(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setString(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setBytes(PreparedStatementProxy statement, int parameterIndex,
                                           byte x[]) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void preparedStatement_setDate(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setTime(PreparedStatementProxy statement, int parameterIndex,
    ...
    public void preparedStatement_setUnicodeStream(PreparedStatementProxy statement,
                                                   ...
                                                   int length) throws SQLException {
        if (this.pos < filterSize) {
            nextFilter().preparedStatement_setUnicodeStream(this, statement, parameterIndex, x,
                length);
            return;
        }
    ...
    @Override
    public void preparedStatement_setObject(PreparedStatementProxy statement, int parameterIndex,
    ...
    public void preparedStatement_setCharacterStream(PreparedStatementProxy statement,
                                                     ...
                                                     int length) throws SQLException {
        if (this.pos < filterSize) {
            nextFilter().preparedStatement_setCharacterStream(this, statement, parameterIndex,
                reader, length);
            return;
        }
    ...
    @Override
    public void preparedStatement_setArray(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setURL(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setRowId(PreparedStatementProxy statement, int parameterIndex,
    ...
    @Override
    public void preparedStatement_setNString(PreparedStatementProxy statement, int parameterIndex,
    ...
    public void preparedStatement_setNCharacterStream(PreparedStatementProxy statement,
                                                      int parameterIndex, Reader value, long length)
                                                                                                    throws SQLException {
        if (this.pos < filterSize) {
            nextFilter().preparedStatement_setNCharacterStream(this, statement, parameterIndex,
                value, length);
            return;
        }
    ...
    @Override
    public void preparedStatement_setNClob(PreparedStatementProxy statement, int parameterIndex,
    ...
    public void preparedStatement_setNClob(PreparedStatementProxy statement, int parameterIndex,
        ...
        if (this.pos < filterSize) {
            nextFilter()
                .preparedStatement_setNClob(this, statement, parameterIndex, reader, length);
            return;
        }
    ...
    @Override
    public void preparedStatement_setSQLXML(PreparedStatementProxy statement, int parameterIndex,
                                            SQLXML xmlObject) throws SQLException {
        if (this.pos < filterSize) {
    ...
    public void callableStatement_registerOutParameter(CallableStatementProxy statement,
                                                       int parameterIndex, int sqlType)
                                                                                       throws SQLException {
        if (this.pos < filterSize) {
            nextFilter().callableStatement_registerOutParameter(this, statement, parameterIndex,
                sqlType);
            return;
        }
    ...
    @Override
    public String callableStatement_getString(CallableStatementProxy statement, int parameterIndex)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public byte callableStatement_getByte(CallableStatementProxy statement, int parameterIndex)
                                                                                               throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public short callableStatement_getShort(CallableStatementProxy statement, int parameterIndex)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public int callableStatement_getInt(CallableStatementProxy statement, int parameterIndex)
                                                                                             throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public long callableStatement_getLong(CallableStatementProxy statement, int parameterIndex)
                                                                                               throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public float callableStatement_getFloat(CallableStatementProxy statement, int parameterIndex)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public double callableStatement_getDouble(CallableStatementProxy statement, int parameterIndex)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public byte[] callableStatement_getBytes(CallableStatementProxy statement, int parameterIndex)
                                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.sql.Date callableStatement_getDate(CallableStatementProxy statement,
    ...
    @Override
    public java.sql.Time callableStatement_getTime(CallableStatementProxy statement,
                                                   int parameterIndex) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.sql.Timestamp callableStatement_getTimestamp(CallableStatementProxy statement,
                                                             int parameterIndex)
                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Ref callableStatement_getRef(CallableStatementProxy statement, int parameterIndex)
                                                                                             throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Blob callableStatement_getBlob(CallableStatementProxy statement, int parameterIndex)
                                                                                               throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Clob callableStatement_getClob(CallableStatementProxy statement, int parameterIndex)
                                                                                               throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Array callableStatement_getArray(CallableStatementProxy statement, int parameterIndex)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    public java.sql.Timestamp callableStatement_getTimestamp(CallableStatementProxy statement,
        ...
        if (this.pos < filterSize) {
            return nextFilter()
                .callableStatement_getTimestamp(this, statement, parameterIndex, cal);
        }
    ...
    public void callableStatement_registerOutParameter(CallableStatementProxy statement,
                                                       String parameterName, int sqlType)
                                                                                         throws SQLException {
        if (this.pos < filterSize) {
            nextFilter().callableStatement_registerOutParameter(this, statement, parameterName,
                sqlType);
            return;
        }
    ...
    @Override
    public java.net.URL callableStatement_getURL(CallableStatementProxy statement,
                                                 int parameterIndex) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setURL(CallableStatementProxy statement, String parameterName,
    ...
    @Override
    public void callableStatement_setNull(CallableStatementProxy statement, String parameterName,
                                          int sqlType) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setByte(CallableStatementProxy statement, String parameterName,
                                          byte x) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setShort(CallableStatementProxy statement, String parameterName,
                                           short x) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setInt(CallableStatementProxy statement, String parameterName,
    ...
    @Override
    public void callableStatement_setLong(CallableStatementProxy statement, String parameterName,
                                          long x) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setFloat(CallableStatementProxy statement, String parameterName,
                                           float x) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setDouble(CallableStatementProxy statement, String parameterName,
                                            double x) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setString(CallableStatementProxy statement, String parameterName,
                                            String x) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setBytes(CallableStatementProxy statement, String parameterName,
                                           byte x[]) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setDate(CallableStatementProxy statement, String parameterName,
                                          java.sql.Date x) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setTime(CallableStatementProxy statement, String parameterName,
                                          java.sql.Time x) throws SQLException {
        if (this.pos < filterSize) {
    ...
    public void callableStatement_setAsciiStream(CallableStatementProxy statement,
        ...
        if (this.pos < filterSize) {
            nextFilter()
                .callableStatement_setAsciiStream(this, statement, parameterName, x, length);
            return;
        }
    ...
    @Override
    public void callableStatement_setObject(CallableStatementProxy statement, String parameterName,
    ...
    public void callableStatement_setCharacterStream(CallableStatementProxy statement,
                                                     ...
                                                     int length) throws SQLException {
        if (this.pos < filterSize) {
            nextFilter().callableStatement_setCharacterStream(this, statement, parameterName,
                reader, length);
            return;
        }
    ...
    @Override
    public byte callableStatement_getByte(CallableStatementProxy statement, String parameterName)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public short callableStatement_getShort(CallableStatementProxy statement, String parameterName)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public int callableStatement_getInt(CallableStatementProxy statement, String parameterName)
                                                                                               throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public long callableStatement_getLong(CallableStatementProxy statement, String parameterName)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public float callableStatement_getFloat(CallableStatementProxy statement, String parameterName)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Ref callableStatement_getRef(CallableStatementProxy statement, String parameterName)
                                                                                               throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Blob callableStatement_getBlob(CallableStatementProxy statement, String parameterName)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Clob callableStatement_getClob(CallableStatementProxy statement, String parameterName)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Array callableStatement_getArray(CallableStatementProxy statement, String parameterName)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public RowId callableStatement_getRowId(CallableStatementProxy statement, int parameterIndex)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public RowId callableStatement_getRowId(CallableStatementProxy statement, String parameterName)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setRowId(CallableStatementProxy statement, String parameterName,
                                           RowId x) throws SQLException {
        if (this.pos < filterSize) {
    ...
    public void callableStatement_setNCharacterStream(CallableStatementProxy statement,
                                                      ...
                                                      long length) throws SQLException {
        if (this.pos < filterSize) {
            nextFilter().callableStatement_setNCharacterStream(this, statement, parameterName,
                value, length);
            return;
        }
    ...
    @Override
    public void callableStatement_setNClob(CallableStatementProxy statement, String parameterName,
                                           NClob value) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setClob(CallableStatementProxy statement, String parameterName,
                                          Reader reader, long length) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public NClob callableStatement_getNClob(CallableStatementProxy statement, int parameterIndex)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public NClob callableStatement_getNClob(CallableStatementProxy statement, String parameterName)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public void callableStatement_setSQLXML(CallableStatementProxy statement, String parameterName,
                                            SQLXML xmlObject) throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public SQLXML callableStatement_getSQLXML(CallableStatementProxy statement, int parameterIndex)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public java.io.Reader callableStatement_getNCharacterStream(CallableStatementProxy statement,
                                                                int parameterIndex)
                                                                                   throws SQLException {
        if (this.pos < filterSize) {
            return nextFilter().callableStatement_getNCharacterStream(this, statement,
                parameterIndex);
        }
    ...
    @Override
    public java.io.Reader callableStatement_getCharacterStream(CallableStatementProxy statement,
                                                               int parameterIndex)
                                                                                  throws SQLException {
        if (this.pos < filterSize) {
            return nextFilter().callableStatement_getCharacterStream(this, statement,
                parameterIndex);
        }
    ...
    public java.io.Reader callableStatement_getCharacterStream(CallableStatementProxy statement,
        ...
        if (this.pos < filterSize) {
            return nextFilter()
                .callableStatement_getCharacterStream(this, statement, parameterName);
        }
    ...
    @Override
    public int clob_setString(ClobProxy clob, long pos, String str, int offset, int len)
                                                                                        throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public Reader clob_getCharacterStream(ClobProxy clob, long pos, long length)
                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    public ConnectionProxy wrap(Connection connection, Properties info) {
        ...
        return new ConnectionProxyImpl(dataSource, connection, info,
            dataSource.createConnectionId());
    }
    ...
    public PreparedStatementProxy wrap(ConnectionProxy connection, PreparedStatement statement,
                                       String sql) {
        if (statement == null) {
            return null;
        }

        return new PreparedStatementProxyImpl(connection, statement, sql,
            dataSource.createStatementId());
    }

    public CallableStatementProxy wrap(ConnectionProxy connection, CallableStatement statement,
                                       String sql) {
        if (statement == null) {
            return null;
        }

        return new CallableStatementProxyImpl(connection, statement, sql,
            dataSource.createStatementId());
    }
    ...
    @Override
    public int resultSetMetaData_getColumnCount(ResultSetMetaDataProxy metaData)
                                                                                throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean resultSetMetaData_isAutoIncrement(ResultSetMetaDataProxy metaData, int column)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean resultSetMetaData_isCaseSensitive(ResultSetMetaDataProxy metaData, int column)
                                                                                                 throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean resultSetMetaData_isSearchable(ResultSetMetaDataProxy metaData, int column)
                                                                                              throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean resultSetMetaData_isCurrency(ResultSetMetaDataProxy metaData, int column)
                                                                                            throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public int resultSetMetaData_isNullable(ResultSetMetaDataProxy metaData, int column)
                                                                                        throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean resultSetMetaData_isSigned(ResultSetMetaDataProxy metaData, int column)
                                                                                          throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public int resultSetMetaData_getColumnDisplaySize(ResultSetMetaDataProxy metaData, int column)
                                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public String resultSetMetaData_getColumnLabel(ResultSetMetaDataProxy metaData, int column)
                                                                                               throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public String resultSetMetaData_getColumnName(ResultSetMetaDataProxy metaData, int column)
                                                                                              throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public String resultSetMetaData_getSchemaName(ResultSetMetaDataProxy metaData, int column)
                                                                                              throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public int resultSetMetaData_getPrecision(ResultSetMetaDataProxy metaData, int column)
                                                                                          throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public int resultSetMetaData_getScale(ResultSetMetaDataProxy metaData, int column)
                                                                                      throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public String resultSetMetaData_getTableName(ResultSetMetaDataProxy metaData, int column)
                                                                                             throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public String resultSetMetaData_getCatalogName(ResultSetMetaDataProxy metaData, int column)
                                                                                               throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public int resultSetMetaData_getColumnType(ResultSetMetaDataProxy metaData, int column)
                                                                                           throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public String resultSetMetaData_getColumnTypeName(ResultSetMetaDataProxy metaData, int column)
                                                                                                  throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean resultSetMetaData_isReadOnly(ResultSetMetaDataProxy metaData, int column)
                                                                                            throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean resultSetMetaData_isWritable(ResultSetMetaDataProxy metaData, int column)
                                                                                            throws SQLException {
        if (this.pos < filterSize) {
    ...
    @Override
    public boolean resultSetMetaData_isDefinitelyWritable(ResultSetMetaDataProxy metaData,
    ...
    @Override
    public String resultSetMetaData_getColumnClassName(ResultSetMetaDataProxy metaData, int column)
                                                                                                   throws SQLException {
        if (this.pos < filterSize) {
