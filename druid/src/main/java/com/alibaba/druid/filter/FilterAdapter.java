...
public abstract class FilterAdapter extends NotificationBroadcasterSupport implements Filter {
    ...
    @Override
    public Array callableStatement_getArray(FilterChain chain, CallableStatementProxy statement,
    ...
    @Override
    public Blob callableStatement_getBlob(FilterChain chain, CallableStatementProxy statement,
                                          int parameterIndex) throws SQLException {
    ...
    @Override
    public byte callableStatement_getByte(FilterChain chain, CallableStatementProxy statement,
                                          int parameterIndex) throws SQLException {
    ...
    @Override
    public byte[] callableStatement_getBytes(FilterChain chain, CallableStatementProxy statement,
                                             int parameterIndex) throws SQLException {
    ...
    @Override
    public java.io.Reader callableStatement_getCharacterStream(FilterChain chain,
                                                               CallableStatementProxy statement,
                                                               int parameterIndex)
                                                                                  throws SQLException {
    ...
    @Override
    public Clob callableStatement_getClob(FilterChain chain, CallableStatementProxy statement,
                                          int parameterIndex) throws SQLException {
    ...
    @Override
    public java.sql.Date callableStatement_getDate(FilterChain chain,
                                                   CallableStatementProxy statement,
                                                   int parameterIndex) throws SQLException {
    ...
    public java.sql.Date callableStatement_getDate(FilterChain chain,
                                                   CallableStatementProxy statement,
                                                   String parameterName, Calendar cal)
                                                                                      throws SQLException {
        return chain.callableStatement_getDate(statement, parameterName, cal);
    }

    @Override
    public double callableStatement_getDouble(FilterChain chain, CallableStatementProxy statement,
                                              int parameterIndex) throws SQLException {
    ...
    @Override
    public float callableStatement_getFloat(FilterChain chain, CallableStatementProxy statement,
                                            int parameterIndex) throws SQLException {
    ...
    @Override
    public int callableStatement_getInt(FilterChain chain, CallableStatementProxy statement,
                                        int parameterIndex) throws SQLException {
    ...
    @Override
    public long callableStatement_getLong(FilterChain chain, CallableStatementProxy statement,
                                          int parameterIndex) throws SQLException {
    ...
    @Override
    public java.io.Reader callableStatement_getNCharacterStream(FilterChain chain,
                                                                CallableStatementProxy statement,
                                                                int parameterIndex)
                                                                                   throws SQLException {
    ...
    @Override
    public NClob callableStatement_getNClob(FilterChain chain, CallableStatementProxy statement,
                                            int parameterIndex) throws SQLException {
    ...
    @Override
    public String callableStatement_getNString(FilterChain chain, CallableStatementProxy statement,
                                               int parameterIndex) throws SQLException {
    ...
    @Override
    public Ref callableStatement_getRef(FilterChain chain, CallableStatementProxy statement,
                                        int parameterIndex) throws SQLException {
    ...
    @Override
    public RowId callableStatement_getRowId(FilterChain chain, CallableStatementProxy statement,
                                            int parameterIndex) throws SQLException {
    ...
    @Override
    public short callableStatement_getShort(FilterChain chain, CallableStatementProxy statement,
                                            int parameterIndex) throws SQLException {
    ...
    @Override
    public SQLXML callableStatement_getSQLXML(FilterChain chain, CallableStatementProxy statement,
                                              int parameterIndex) throws SQLException {
    ...
    @Override
    public String callableStatement_getString(FilterChain chain, CallableStatementProxy statement,
                                              int parameterIndex) throws SQLException {
    ...
    @Override
    public java.sql.Time callableStatement_getTime(FilterChain chain,
                                                   CallableStatementProxy statement,
                                                   int parameterIndex) throws SQLException {
    ...
    @Override
    public java.sql.Timestamp callableStatement_getTimestamp(FilterChain chain,
                                                             CallableStatementProxy statement,
                                                             int parameterIndex)
                                                                                throws SQLException {
    ...
    public void callableStatement_setAsciiStream(FilterChain chain,
                                                 CallableStatementProxy statement,
                                                 String parameterName, java.io.InputStream x)
                                                                                             throws SQLException {
    ...
    public void callableStatement_setBigDecimal(FilterChain chain,
                                                CallableStatementProxy statement,
                                                String parameterName, BigDecimal x)
                                                                                   throws SQLException {
    ...
    @Override
    public void callableStatement_setBlob(FilterChain chain, CallableStatementProxy statement,
    ...
    @Override
    public void callableStatement_setBlob(FilterChain chain, CallableStatementProxy statement,
                                          String parameterName, InputStream inputStream)
                                                                                        throws SQLException {
    ...
    @Override
    public void callableStatement_setBoolean(FilterChain chain, CallableStatementProxy statement,
                                             String parameterName, boolean x) throws SQLException {
        chain.callableStatement_setBoolean(statement, parameterName, x);
    }

    @Override
    public void callableStatement_setByte(FilterChain chain, CallableStatementProxy statement,
                                          String parameterName, byte x) throws SQLException {
        chain.callableStatement_setByte(statement, parameterName, x);
    }

    @Override
    public void callableStatement_setBytes(FilterChain chain, CallableStatementProxy statement,
                                           String parameterName, byte x[]) throws SQLException {
    ...
    public void callableStatement_setCharacterStream(FilterChain chain,
                                                     CallableStatementProxy statement,
                                                     String parameterName, java.io.Reader reader)
                                                                                                 throws SQLException {
    ...
    @Override
    public void callableStatement_setClob(FilterChain chain, CallableStatementProxy statement,
    ...
    @Override
    public void callableStatement_setDate(FilterChain chain, CallableStatementProxy statement,
                                          String parameterName, java.sql.Date x)
                                                                                throws SQLException {
    ...
    @Override
    public void callableStatement_setDouble(FilterChain chain, CallableStatementProxy statement,
                                            String parameterName, double x) throws SQLException {
        chain.callableStatement_setDouble(statement, parameterName, x);
    }

    @Override
    public void callableStatement_setFloat(FilterChain chain, CallableStatementProxy statement,
                                           String parameterName, float x) throws SQLException {
        chain.callableStatement_setFloat(statement, parameterName, x);
    }

    @Override
    public void callableStatement_setInt(FilterChain chain, CallableStatementProxy statement,
                                         String parameterName, int x) throws SQLException {
        chain.callableStatement_setInt(statement, parameterName, x);
    }

    @Override
    public void callableStatement_setLong(FilterChain chain, CallableStatementProxy statement,
    ...
    @Override
    public void callableStatement_setNClob(FilterChain chain, CallableStatementProxy statement,
    ...
    @Override
    public void callableStatement_setNString(FilterChain chain, CallableStatementProxy statement,
    ...
    @Override
    public void callableStatement_setNull(FilterChain chain, CallableStatementProxy statement,
    ...
    @Override
    public void callableStatement_setObject(FilterChain chain, CallableStatementProxy statement,
    ...
    @Override
    public void callableStatement_setRowId(FilterChain chain, CallableStatementProxy statement,
                                           String parameterName, RowId x) throws SQLException {
        chain.callableStatement_setRowId(statement, parameterName, x);
    }

    @Override
    public void callableStatement_setShort(FilterChain chain, CallableStatementProxy statement,
                                           String parameterName, short x) throws SQLException {
        chain.callableStatement_setShort(statement, parameterName, x);
    }

    @Override
    public void callableStatement_setSQLXML(FilterChain chain, CallableStatementProxy statement,
    ...
    @Override
    public void callableStatement_setString(FilterChain chain, CallableStatementProxy statement,
                                            String parameterName, String x) throws SQLException {
        chain.callableStatement_setString(statement, parameterName, x);
    }

    @Override
    public void callableStatement_setTime(FilterChain chain, CallableStatementProxy statement,
                                          String parameterName, java.sql.Time x)
                                                                                throws SQLException {
    ...
    public void callableStatement_setTimestamp(FilterChain chain, CallableStatementProxy statement,
                                               String parameterName, java.sql.Timestamp x)
                                                                                          throws SQLException {
    ...
    @Override
    public void callableStatement_setURL(FilterChain chain, CallableStatementProxy statement,
                                         String parameterName, java.net.URL val)
                                                                                throws SQLException {
    ...
    @Override
    public void connection_clearWarnings(FilterChain chain, ConnectionProxy connection)
                                                                                       throws SQLException {
    ...
    @Override
    public Array connection_createArrayOf(FilterChain chain, ConnectionProxy connection,
                                          String typeName, Object[] elements) throws SQLException {
        return chain.connection_createArrayOf(connection, typeName, elements);
    }

    @Override
    public Blob connection_createBlob(FilterChain chain, ConnectionProxy connection)
                                                                                    throws SQLException {
        return chain.connection_createBlob(connection);
    }

    @Override
    public Clob connection_createClob(FilterChain chain, ConnectionProxy connection)
                                                                                    throws SQLException {
        return chain.connection_createClob(connection);
    }

    @Override
    public NClob connection_createNClob(FilterChain chain, ConnectionProxy connection)
                                                                                      throws SQLException {
        return chain.connection_createNClob(connection);
    }

    @Override
    public SQLXML connection_createSQLXML(FilterChain chain, ConnectionProxy connection)
                                                                                        throws SQLException {
        return chain.connection_createSQLXML(connection);
    }

    @Override
    public StatementProxy connection_createStatement(FilterChain chain, ConnectionProxy connection)
                                                                                                   throws SQLException {
    ...
    @Override
    public Struct connection_createStruct(FilterChain chain, ConnectionProxy connection,
                                          String typeName, Object[] attributes) throws SQLException {
        return chain.connection_createStruct(connection, typeName, attributes);
    }

    @Override
    public boolean connection_getAutoCommit(FilterChain chain, ConnectionProxy connection)
                                                                                          throws SQLException {
        return chain.connection_getAutoCommit(connection);
    }

    @Override
    public String connection_getCatalog(FilterChain chain, ConnectionProxy connection)
                                                                                      throws SQLException {
        return chain.connection_getCatalog(connection);
    }

    @Override
    public Properties connection_getClientInfo(FilterChain chain, ConnectionProxy connection)
                                                                                             throws SQLException {
        return chain.connection_getClientInfo(connection);
    }

    @Override
    public String connection_getClientInfo(FilterChain chain, ConnectionProxy connection,
                                           String name) throws SQLException {
        return chain.connection_getClientInfo(connection, name);
    }

    @Override
    public int connection_getHoldability(FilterChain chain, ConnectionProxy connection)
                                                                                       throws SQLException {
        return chain.connection_getHoldability(connection);
    }

    @Override
    public DatabaseMetaData connection_getMetaData(FilterChain chain, ConnectionProxy connection)
                                                                                                 throws SQLException {
    ...
    @Override
    public SQLWarning connection_getWarnings(FilterChain chain, ConnectionProxy connection)
                                                                                           throws SQLException {
        return chain.connection_getWarnings(connection);
    }

    @Override
    public boolean connection_isClosed(FilterChain chain, ConnectionProxy connection)
                                                                                     throws SQLException {
        return chain.connection_isClosed(connection);
    }

    @Override
    public boolean connection_isReadOnly(FilterChain chain, ConnectionProxy connection)
                                                                                       throws SQLException {
        return chain.connection_isReadOnly(connection);
    }

    @Override
    public boolean connection_isValid(FilterChain chain, ConnectionProxy connection, int timeout)
                                                                                                 throws SQLException {
        return chain.connection_isValid(connection, timeout);
    }

    @Override
    public String connection_nativeSQL(FilterChain chain, ConnectionProxy connection, String sql)
                                                                                                 throws SQLException {
    ...
    public CallableStatementProxy connection_prepareCall(FilterChain chain,
                                                         ConnectionProxy connection, String sql)
                                                                                                throws SQLException {
    ...
    public PreparedStatementProxy connection_prepareStatement(FilterChain chain,
                                                              ...
                                                              int resultSetConcurrency)
                                                                                       throws SQLException {
        return chain.connection_prepareStatement(connection, sql, resultSetType,
    ...
    @Override
    public void connection_releaseSavepoint(FilterChain chain, ConnectionProxy connection,
    ...
    @Override
    public void connection_setAutoCommit(FilterChain chain, ConnectionProxy connection,
    ...
    @Override
    public void connection_setClientInfo(FilterChain chain, ConnectionProxy connection,
    ...
    @Override
    public void connection_setHoldability(FilterChain chain, ConnectionProxy connection,
                                          int holdability) throws SQLException {
        chain.connection_setHoldability(connection, holdability);
    }

    @Override
    public void connection_setReadOnly(FilterChain chain, ConnectionProxy connection,
    ...
    @Override
    public void connection_setTransactionIsolation(FilterChain chain, ConnectionProxy connection,
                                                   int level) throws SQLException {
        chain.connection_setTransactionIsolation(connection, level);
    }

    @Override
    public void connection_setTypeMap(FilterChain chain, ConnectionProxy connection,
                                      Map<String, Class<?>> map) throws SQLException {
        chain.connection_setTypeMap(connection, map);
    }

    @Override
    public boolean isWrapperFor(FilterChain chain, Wrapper wrapper, Class<?> iface)
                                                                                   throws SQLException {
        return chain.isWrapperFor(wrapper, iface);
    }

    @Override
    public void preparedStatement_addBatch(FilterChain chain, PreparedStatementProxy statement)
                                                                                               throws SQLException {
    ...
    @Override
    public void preparedStatement_setArray(FilterChain chain, PreparedStatementProxy statement,
    ...
    public void preparedStatement_setAsciiStream(FilterChain chain,
                                                 PreparedStatementProxy statement,
                                                 int parameterIndex, java.io.InputStream x)
                                                                                           throws SQLException {
    ...
    @Override
    public void preparedStatement_setBlob(FilterChain chain, PreparedStatementProxy statement,
    ...
    @Override
    public void preparedStatement_setBoolean(FilterChain chain, PreparedStatementProxy statement,
                                             int parameterIndex, boolean x) throws SQLException {
        chain.preparedStatement_setBoolean(statement, parameterIndex, x);
    }

    @Override
    public void preparedStatement_setByte(FilterChain chain, PreparedStatementProxy statement,
                                          int parameterIndex, byte x) throws SQLException {
        chain.preparedStatement_setByte(statement, parameterIndex, x);
    }

    @Override
    public void preparedStatement_setBytes(FilterChain chain, PreparedStatementProxy statement,
                                           int parameterIndex, byte x[]) throws SQLException {
    ...
    public void preparedStatement_setCharacterStream(FilterChain chain,
                                                     PreparedStatementProxy statement,
                                                     int parameterIndex, java.io.Reader reader)
                                                                                               throws SQLException {
    ...
    @Override
    public void preparedStatement_setClob(FilterChain chain, PreparedStatementProxy statement,
    ...
    @Override
    public void preparedStatement_setDate(FilterChain chain, PreparedStatementProxy statement,
    ...
    @Override
    public void preparedStatement_setDouble(FilterChain chain, PreparedStatementProxy statement,
                                            int parameterIndex, double x) throws SQLException {
        chain.preparedStatement_setDouble(statement, parameterIndex, x);
    }

    @Override
    public void preparedStatement_setFloat(FilterChain chain, PreparedStatementProxy statement,
                                           int parameterIndex, float x) throws SQLException {
        chain.preparedStatement_setFloat(statement, parameterIndex, x);
    }

    @Override
    public void preparedStatement_setInt(FilterChain chain, PreparedStatementProxy statement,
                                         int parameterIndex, int x) throws SQLException {
        chain.preparedStatement_setInt(statement, parameterIndex, x);
    }

    @Override
    public void preparedStatement_setLong(FilterChain chain, PreparedStatementProxy statement,
    ...
    public void preparedStatement_setNCharacterStream(FilterChain chain,
                                                      PreparedStatementProxy statement,
                                                      int parameterIndex, Reader value)
                                                                                       throws SQLException {
    ...
    @Override
    public void preparedStatement_setNClob(FilterChain chain, PreparedStatementProxy statement,
    ...
    @Override
    public void preparedStatement_setNString(FilterChain chain, PreparedStatementProxy statement,
                                             int parameterIndex, String value) throws SQLException {
        chain.preparedStatement_setNString(statement, parameterIndex, value);
    }

    @Override
    public void preparedStatement_setNull(FilterChain chain, PreparedStatementProxy statement,
    ...
    @Override
    public void preparedStatement_setObject(FilterChain chain, PreparedStatementProxy statement,
    ...
    @Override
    public void preparedStatement_setRef(FilterChain chain, PreparedStatementProxy statement,
                                         int parameterIndex, Ref x) throws SQLException {
        chain.preparedStatement_setRef(statement, parameterIndex, x);
    }

    @Override
    public void preparedStatement_setRowId(FilterChain chain, PreparedStatementProxy statement,
                                           int parameterIndex, RowId x) throws SQLException {
        chain.preparedStatement_setRowId(statement, parameterIndex, x);
    }

    @Override
    public void preparedStatement_setShort(FilterChain chain, PreparedStatementProxy statement,
                                           int parameterIndex, short x) throws SQLException {
        chain.preparedStatement_setShort(statement, parameterIndex, x);
    }

    @Override
    public void preparedStatement_setSQLXML(FilterChain chain, PreparedStatementProxy statement,
    ...
    @Override
    public void preparedStatement_setString(FilterChain chain, PreparedStatementProxy statement,
                                            int parameterIndex, String x) throws SQLException {
        chain.preparedStatement_setString(statement, parameterIndex, x);
    }

    @Override
    public void preparedStatement_setTime(FilterChain chain, PreparedStatementProxy statement,
    ...
    @Override
    public void preparedStatement_setTimestamp(FilterChain chain, PreparedStatementProxy statement,
                                               int parameterIndex, java.sql.Timestamp x)
                                                                                        throws SQLException {
    ...
    @Override
    public void preparedStatement_setURL(FilterChain chain, PreparedStatementProxy statement,
                                         int parameterIndex, java.net.URL x) throws SQLException {
        chain.preparedStatement_setURL(statement, parameterIndex, x);
    }

    @Override
    public boolean resultSet_absolute(FilterChain chain, ResultSetProxy result, int row)
                                                                                        throws SQLException {
        return chain.resultSet_absolute(result, row);
    }

    @Override
    public void resultSet_afterLast(FilterChain chain, ResultSetProxy resultSet)
                                                                                throws SQLException {
        chain.resultSet_afterLast(resultSet);
    }

    @Override
    public void resultSet_beforeFirst(FilterChain chain, ResultSetProxy resultSet)
                                                                                  throws SQLException {
        chain.resultSet_beforeFirst(resultSet);
    }

    @Override
    public void resultSet_cancelRowUpdates(FilterChain chain, ResultSetProxy resultSet)
                                                                                       throws SQLException {
        chain.resultSet_cancelRowUpdates(resultSet);
    }

    @Override
    public void resultSet_clearWarnings(FilterChain chain, ResultSetProxy resultSet)
                                                                                    throws SQLException {
    ...
    @Override
    public void resultSet_deleteRow(FilterChain chain, ResultSetProxy resultSet)
                                                                                throws SQLException {
        chain.resultSet_deleteRow(resultSet);
    }

    @Override
    public int resultSet_findColumn(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                 throws SQLException {
    ...
    @Override
    public Array resultSet_getArray(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                              throws SQLException {
        return chain.resultSet_getArray(result, columnIndex);
    }

    @Override
    public Array resultSet_getArray(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                 throws SQLException {
    ...
    @Override
    public BigDecimal resultSet_getBigDecimal(FilterChain chain, ResultSetProxy result,
                                              int columnIndex) throws SQLException {
    ...
    @Override
    public java.io.InputStream resultSet_getBinaryStream(FilterChain chain, ResultSetProxy result,
                                                         int columnIndex) throws SQLException {
    ...
    @Override
    public boolean resultSet_getBoolean(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                                  throws SQLException {
    ...
    @Override
    public byte resultSet_getByte(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                            throws SQLException {
        return chain.resultSet_getByte(result, columnIndex);
    }

    @Override
    public byte resultSet_getByte(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                               throws SQLException {
    ...
    @Override
    public byte[] resultSet_getBytes(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                  throws SQLException {
        return chain.resultSet_getBytes(result, columnLabel);
    }

    @Override
    public java.io.Reader resultSet_getCharacterStream(FilterChain chain, ResultSetProxy result,
                                                       int columnIndex) throws SQLException {
    ...
    @Override
    public int resultSet_getConcurrency(FilterChain chain, ResultSetProxy resultSet)
                                                                                    throws SQLException {
        return chain.resultSet_getConcurrency(resultSet);
    }

    @Override
    public String resultSet_getCursorName(FilterChain chain, ResultSetProxy resultSet)
                                                                                      throws SQLException {
    ...
    @Override
    public java.sql.Date resultSet_getDate(FilterChain chain, ResultSetProxy result,
    ...
    @Override
    public double resultSet_getDouble(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                                throws SQLException {
        return chain.resultSet_getDouble(result, columnIndex);
    }

    @Override
    public double resultSet_getDouble(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                   throws SQLException {
        return chain.resultSet_getDouble(result, columnLabel);
    }

    @Override
    public int resultSet_getFetchDirection(FilterChain chain, ResultSetProxy resultSet)
                                                                                       throws SQLException {
        return chain.resultSet_getFetchDirection(resultSet);
    }

    @Override
    public int resultSet_getFetchSize(FilterChain chain, ResultSetProxy resultSet)
                                                                                  throws SQLException {
        return chain.resultSet_getFetchSize(resultSet);
    }

    @Override
    public float resultSet_getFloat(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                              throws SQLException {
        return chain.resultSet_getFloat(result, columnIndex);
    }

    @Override
    public float resultSet_getFloat(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                 throws SQLException {
        return chain.resultSet_getFloat(result, columnLabel);
    }

    @Override
    public int resultSet_getHoldability(FilterChain chain, ResultSetProxy resultSet)
                                                                                    throws SQLException {
        return chain.resultSet_getHoldability(resultSet);
    }

    @Override
    public int resultSet_getInt(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                          throws SQLException {
        return chain.resultSet_getInt(result, columnIndex);
    }

    @Override
    public int resultSet_getInt(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                             throws SQLException {
        return chain.resultSet_getInt(result, columnLabel);
    }

    @Override
    public long resultSet_getLong(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                            throws SQLException {
        return chain.resultSet_getLong(result, columnIndex);
    }

    @Override
    public long resultSet_getLong(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                               throws SQLException {
        return chain.resultSet_getLong(result, columnLabel);
    }

    @Override
    public ResultSetMetaData resultSet_getMetaData(FilterChain chain, ResultSetProxy resultSet)
                                                                                               throws SQLException {
        return chain.resultSet_getMetaData(resultSet);
    }

    @Override
    public java.io.Reader resultSet_getNCharacterStream(FilterChain chain, ResultSetProxy result,
                                                        int columnIndex) throws SQLException {
    ...
    @Override
    public NClob resultSet_getNClob(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                              throws SQLException {
        return chain.resultSet_getNClob(result, columnIndex);
    }

    @Override
    public NClob resultSet_getNClob(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                 throws SQLException {
        return chain.resultSet_getNClob(result, columnLabel);
    }

    @Override
    public String resultSet_getNString(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                                 throws SQLException {
    ...
    @Override
    public Ref resultSet_getRef(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                          throws SQLException {
        return chain.resultSet_getRef(result, columnIndex);
    }

    @Override
    public Ref resultSet_getRef(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                             throws SQLException {
    ...
    @Override
    public RowId resultSet_getRowId(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                              throws SQLException {
        return chain.resultSet_getRowId(result, columnIndex);
    }

    @Override
    public RowId resultSet_getRowId(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                 throws SQLException {
        return chain.resultSet_getRowId(result, columnLabel);
    }

    @Override
    public short resultSet_getShort(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                              throws SQLException {
        return chain.resultSet_getShort(result, columnIndex);
    }

    @Override
    public short resultSet_getShort(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                 throws SQLException {
        return chain.resultSet_getShort(result, columnLabel);
    }

    @Override
    public SQLXML resultSet_getSQLXML(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                                throws SQLException {
        return chain.resultSet_getSQLXML(result, columnIndex);
    }

    @Override
    public SQLXML resultSet_getSQLXML(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                   throws SQLException {
        return chain.resultSet_getSQLXML(result, columnLabel);
    }

    @Override
    public Statement resultSet_getStatement(FilterChain chain, ResultSetProxy resultSet)
                                                                                        throws SQLException {
    ...
    @Override
    public String resultSet_getString(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                   throws SQLException {
    ...
    @Override
    public java.sql.Time resultSet_getTime(FilterChain chain, ResultSetProxy result,
                                           int columnIndex, Calendar cal) throws SQLException {
    ...
    @Override
    public java.sql.Timestamp resultSet_getTimestamp(FilterChain chain, ResultSetProxy result,
                                                     int columnIndex) throws SQLException {
    ...
    @Override
    public java.io.InputStream resultSet_getUnicodeStream(FilterChain chain, ResultSetProxy result,
                                                          int columnIndex) throws SQLException {
    ...
    @Override
    public java.net.URL resultSet_getURL(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                                   throws SQLException {
        return chain.resultSet_getURL(result, columnIndex);
    }

    @Override
    public java.net.URL resultSet_getURL(FilterChain chain, ResultSetProxy result,
                                         String columnLabel) throws SQLException {
        return chain.resultSet_getURL(result, columnLabel);
    }

    @Override
    public SQLWarning resultSet_getWarnings(FilterChain chain, ResultSetProxy resultSet)
                                                                                        throws SQLException {
        return chain.resultSet_getWarnings(resultSet);
    }

    @Override
    public void resultSet_insertRow(FilterChain chain, ResultSetProxy resultSet)
                                                                                throws SQLException {
        chain.resultSet_insertRow(resultSet);
    }

    @Override
    public boolean resultSet_isAfterLast(FilterChain chain, ResultSetProxy resultSet)
                                                                                     throws SQLException {
        return chain.resultSet_isAfterLast(resultSet);
    }

    @Override
    public boolean resultSet_isBeforeFirst(FilterChain chain, ResultSetProxy resultSet)
                                                                                       throws SQLException {
        return chain.resultSet_isBeforeFirst(resultSet);
    }

    @Override
    public boolean resultSet_isClosed(FilterChain chain, ResultSetProxy resultSet)
                                                                                  throws SQLException {
        return chain.resultSet_isClosed(resultSet);
    }

    @Override
    public boolean resultSet_isFirst(FilterChain chain, ResultSetProxy resultSet)
                                                                                 throws SQLException {
        return chain.resultSet_isFirst(resultSet);
    }

    @Override
    public boolean resultSet_isLast(FilterChain chain, ResultSetProxy resultSet)
                                                                                throws SQLException {
    ...
    @Override
    public void resultSet_moveToCurrentRow(FilterChain chain, ResultSetProxy resultSet)
                                                                                       throws SQLException {
        chain.resultSet_moveToCurrentRow(resultSet);
    }

    @Override
    public void resultSet_moveToInsertRow(FilterChain chain, ResultSetProxy resultSet)
                                                                                      throws SQLException {
    ...
    @Override
    public boolean resultSet_previous(FilterChain chain, ResultSetProxy resultSet)
                                                                                  throws SQLException {
        return chain.resultSet_previous(resultSet);
    }

    @Override
    public void resultSet_refreshRow(FilterChain chain, ResultSetProxy resultSet)
                                                                                 throws SQLException {
        chain.resultSet_refreshRow(resultSet);
    }

    @Override
    public boolean resultSet_relative(FilterChain chain, ResultSetProxy result, int rows)
                                                                                         throws SQLException {
        return chain.resultSet_relative(result, rows);
    }

    @Override
    public boolean resultSet_rowDeleted(FilterChain chain, ResultSetProxy resultSet)
                                                                                    throws SQLException {
        return chain.resultSet_rowDeleted(resultSet);
    }

    @Override
    public boolean resultSet_rowInserted(FilterChain chain, ResultSetProxy resultSet)
                                                                                     throws SQLException {
        return chain.resultSet_rowInserted(resultSet);
    }

    @Override
    public boolean resultSet_rowUpdated(FilterChain chain, ResultSetProxy resultSet)
                                                                                    throws SQLException {
    ...
    @Override
    public void resultSet_setFetchSize(FilterChain chain, ResultSetProxy result, int rows)
                                                                                          throws SQLException {
        chain.resultSet_setFetchSize(result, rows);
    }

    @Override
    public void resultSet_updateArray(FilterChain chain, ResultSetProxy result, int columnIndex,
                                      java.sql.Array x) throws SQLException {
        chain.resultSet_updateArray(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateArray(FilterChain chain, ResultSetProxy result, String columnLabel,
                                      java.sql.Array x) throws SQLException {
        chain.resultSet_updateArray(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateAsciiStream(FilterChain chain, ResultSetProxy result,
                                            int columnIndex, java.io.InputStream x)
                                                                                   throws SQLException {
    ...
    @Override
    public void resultSet_updateAsciiStream(FilterChain chain, ResultSetProxy result,
                                            String columnLabel, java.io.InputStream x)
                                                                                      throws SQLException {
    ...
    @Override
    public void resultSet_updateBigDecimal(FilterChain chain, ResultSetProxy result,
    ...
    @Override
    public void resultSet_updateBinaryStream(FilterChain chain, ResultSetProxy result,
                                             int columnIndex, java.io.InputStream x)
                                                                                    throws SQLException {
    ...
    @Override
    public void resultSet_updateBoolean(FilterChain chain, ResultSetProxy result, int columnIndex,
                                        boolean x) throws SQLException {
        chain.resultSet_updateBoolean(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateBoolean(FilterChain chain, ResultSetProxy result,
                                        String columnLabel, boolean x) throws SQLException {
        chain.resultSet_updateBoolean(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateByte(FilterChain chain, ResultSetProxy result, int columnIndex,
                                     byte x) throws SQLException {
        chain.resultSet_updateByte(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateByte(FilterChain chain, ResultSetProxy result, String columnLabel,
                                     byte x) throws SQLException {
        chain.resultSet_updateByte(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateBytes(FilterChain chain, ResultSetProxy result, int columnIndex,
                                      byte[] x) throws SQLException {
        chain.resultSet_updateBytes(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateBytes(FilterChain chain, ResultSetProxy result, String columnLabel,
                                      byte[] x) throws SQLException {
        chain.resultSet_updateBytes(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateCharacterStream(FilterChain chain, ResultSetProxy result,
                                                int columnIndex, java.io.Reader x)
                                                                                  throws SQLException {
    ...
    @Override
    public void resultSet_updateCharacterStream(FilterChain chain, ResultSetProxy result,
                                                int columnIndex, java.io.Reader x, int length)
                                                                                              throws SQLException {
    ...
    @Override
    public void resultSet_updateCharacterStream(FilterChain chain, ResultSetProxy result,
                                                int columnIndex, java.io.Reader x, long length)
                                                                                               throws SQLException {
        chain.resultSet_updateCharacterStream(result, columnIndex, x, length);
    }
    ...
    @Override
    public void resultSet_updateCharacterStream(FilterChain chain, ResultSetProxy result,
                                                String columnLabel, java.io.Reader reader)
                                                                                          throws SQLException {
    ...
    @Override
    public void resultSet_updateClob(FilterChain chain, ResultSetProxy result, int columnIndex,
    ...
    @Override
    public void resultSet_updateClob(FilterChain chain, ResultSetProxy result, String columnLabel,
                                     java.sql.Clob x) throws SQLException {
    ...
    @Override
    public void resultSet_updateDate(FilterChain chain, ResultSetProxy result, int columnIndex,
                                     java.sql.Date x) throws SQLException {
        chain.resultSet_updateDate(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateDate(FilterChain chain, ResultSetProxy result, String columnLabel,
                                     java.sql.Date x) throws SQLException {
        chain.resultSet_updateDate(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateDouble(FilterChain chain, ResultSetProxy result, int columnIndex,
                                       double x) throws SQLException {
        chain.resultSet_updateDouble(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateDouble(FilterChain chain, ResultSetProxy result,
                                       String columnLabel, double x) throws SQLException {
        chain.resultSet_updateDouble(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateFloat(FilterChain chain, ResultSetProxy result, int columnIndex,
                                      float x) throws SQLException {
        chain.resultSet_updateFloat(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateFloat(FilterChain chain, ResultSetProxy result, String columnLabel,
                                      float x) throws SQLException {
    ...
    @Override
    public void resultSet_updateInt(FilterChain chain, ResultSetProxy result, String columnLabel,
                                    int x) throws SQLException {
        chain.resultSet_updateInt(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateLong(FilterChain chain, ResultSetProxy result, int columnIndex,
                                     long x) throws SQLException {
        chain.resultSet_updateLong(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateLong(FilterChain chain, ResultSetProxy result, String columnLabel,
                                     long x) throws SQLException {
        chain.resultSet_updateLong(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateNCharacterStream(FilterChain chain, ResultSetProxy result,
                                                 int columnIndex, java.io.Reader x)
                                                                                   throws SQLException {
    ...
    @Override
    public void resultSet_updateNClob(FilterChain chain, ResultSetProxy result, int columnIndex,
    ...
    @Override
    public void resultSet_updateNClob(FilterChain chain, ResultSetProxy result, String columnLabel,
                                      NClob nClob) throws SQLException {
    ...
    @Override
    public void resultSet_updateNString(FilterChain chain, ResultSetProxy result, int columnIndex,
                                        String nString) throws SQLException {
        chain.resultSet_updateNString(result, columnIndex, nString);
    }

    @Override
    public void resultSet_updateNString(FilterChain chain, ResultSetProxy result,
                                        String columnLabel, String nString) throws SQLException {
        chain.resultSet_updateNString(result, columnLabel, nString);
    }

    @Override
    public void resultSet_updateNull(FilterChain chain, ResultSetProxy result, int columnIndex)
                                                                                               throws SQLException {
        chain.resultSet_updateNull(result, columnIndex);
    }

    @Override
    public void resultSet_updateNull(FilterChain chain, ResultSetProxy result, String columnLabel)
                                                                                                  throws SQLException {
        chain.resultSet_updateNull(result, columnLabel);
    }

    @Override
    public void resultSet_updateObject(FilterChain chain, ResultSetProxy result, int columnIndex,
    ...
    @Override
    public void resultSet_updateObject(FilterChain chain, ResultSetProxy result,
                                       String columnLabel, Object x) throws SQLException {
    ...
    @Override
    public void resultSet_updateRef(FilterChain chain, ResultSetProxy result, int columnIndex,
                                    java.sql.Ref x) throws SQLException {
        chain.resultSet_updateRef(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateRef(FilterChain chain, ResultSetProxy result, String columnLabel,
                                    java.sql.Ref x) throws SQLException {
        chain.resultSet_updateRef(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateRow(FilterChain chain, ResultSetProxy resultSet)
                                                                                throws SQLException {
        chain.resultSet_updateRow(resultSet);
    }

    @Override
    public void resultSet_updateRowId(FilterChain chain, ResultSetProxy result, int columnIndex,
                                      RowId x) throws SQLException {
        chain.resultSet_updateRowId(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateRowId(FilterChain chain, ResultSetProxy result, String columnLabel,
                                      RowId x) throws SQLException {
        chain.resultSet_updateRowId(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateShort(FilterChain chain, ResultSetProxy result, int columnIndex,
                                      short x) throws SQLException {
        chain.resultSet_updateShort(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateShort(FilterChain chain, ResultSetProxy result, String columnLabel,
                                      short x) throws SQLException {
        chain.resultSet_updateShort(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateSQLXML(FilterChain chain, ResultSetProxy result, int columnIndex,
                                       SQLXML xmlObject) throws SQLException {
        chain.resultSet_updateSQLXML(result, columnIndex, xmlObject);
    }

    @Override
    public void resultSet_updateSQLXML(FilterChain chain, ResultSetProxy result,
                                       String columnLabel, SQLXML xmlObject) throws SQLException {
        chain.resultSet_updateSQLXML(result, columnLabel, xmlObject);
    }

    @Override
    public void resultSet_updateString(FilterChain chain, ResultSetProxy result, int columnIndex,
                                       String x) throws SQLException {
        chain.resultSet_updateString(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateString(FilterChain chain, ResultSetProxy result,
                                       String columnLabel, String x) throws SQLException {
        chain.resultSet_updateString(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateTime(FilterChain chain, ResultSetProxy result, int columnIndex,
                                     java.sql.Time x) throws SQLException {
        chain.resultSet_updateTime(result, columnIndex, x);
    }

    @Override
    public void resultSet_updateTime(FilterChain chain, ResultSetProxy result, String columnLabel,
                                     java.sql.Time x) throws SQLException {
        chain.resultSet_updateTime(result, columnLabel, x);
    }

    @Override
    public void resultSet_updateTimestamp(FilterChain chain, ResultSetProxy result,
    ...
    @Override
    public boolean resultSet_wasNull(FilterChain chain, ResultSetProxy resultSet)
                                                                                 throws SQLException {
        return chain.resultSet_wasNull(resultSet);
    }

    @Override
    public void statement_addBatch(FilterChain chain, StatementProxy statement, String sql)
                                                                                           throws SQLException {
    ...
    @Override
    public int[] statement_executeBatch(FilterChain chain, StatementProxy statement)
                                                                                    throws SQLException {
    ...
    // /////////////////////////////
    @Override
    public ResultSetProxy statement_executeQuery(FilterChain chain, StatementProxy statement,
    ...
    @Override
    public Connection statement_getConnection(FilterChain chain, StatementProxy statement)
                                                                                          throws SQLException {
        return chain.statement_getConnection(statement);
    }

    @Override
    public int statement_getFetchDirection(FilterChain chain, StatementProxy statement)
                                                                                       throws SQLException {
        return chain.statement_getFetchDirection(statement);
    }

    @Override
    public int statement_getFetchSize(FilterChain chain, StatementProxy statement)
                                                                                  throws SQLException {
        return chain.statement_getFetchSize(statement);
    }

    @Override
    public ResultSetProxy statement_getGeneratedKeys(FilterChain chain, StatementProxy statement)
                                                                                                 throws SQLException {
        return chain.statement_getGeneratedKeys(statement);
    }

    @Override
    public int statement_getMaxFieldSize(FilterChain chain, StatementProxy statement)
                                                                                     throws SQLException {
        return chain.statement_getMaxFieldSize(statement);
    }

    @Override
    public int statement_getMaxRows(FilterChain chain, StatementProxy statement)
                                                                                throws SQLException {
        return chain.statement_getMaxRows(statement);
    }

    @Override
    public boolean statement_getMoreResults(FilterChain chain, StatementProxy statement)
                                                                                        throws SQLException {
    ...
    @Override
    public int statement_getQueryTimeout(FilterChain chain, StatementProxy statement)
                                                                                     throws SQLException {
    ...
    @Override
    public ResultSetProxy statement_getResultSet(FilterChain chain, StatementProxy statement)
                                                                                             throws SQLException {
        return chain.statement_getResultSet(statement);
    }

    @Override
    public int statement_getResultSetConcurrency(FilterChain chain, StatementProxy statement)
                                                                                             throws SQLException {
        return chain.statement_getResultSetConcurrency(statement);
    }

    @Override
    public int statement_getResultSetHoldability(FilterChain chain, StatementProxy statement)
                                                                                             throws SQLException {
        return chain.statement_getResultSetHoldability(statement);
    }

    @Override
    public int statement_getResultSetType(FilterChain chain, StatementProxy statement)
                                                                                      throws SQLException {
        return chain.statement_getResultSetType(statement);
    }

    @Override
    public int statement_getUpdateCount(FilterChain chain, StatementProxy statement)
                                                                                    throws SQLException {
        return chain.statement_getUpdateCount(statement);
    }

    @Override
    public SQLWarning statement_getWarnings(FilterChain chain, StatementProxy statement)
                                                                                        throws SQLException {
        return chain.statement_getWarnings(statement);
    }

    @Override
    public void statement_clearWarnings(FilterChain chain, StatementProxy statement)
                                                                                    throws SQLException {
        chain.statement_clearWarnings(statement);
    }

    @Override
    public boolean statement_isClosed(FilterChain chain, StatementProxy statement)
                                                                                  throws SQLException {
        return chain.statement_isClosed(statement);
    }

    @Override
    public boolean statement_isPoolable(FilterChain chain, StatementProxy statement)
                                                                                    throws SQLException {
    ...
    @Override
    public void statement_setEscapeProcessing(FilterChain chain, StatementProxy statement,
                                              boolean enable) throws SQLException {
        chain.statement_setEscapeProcessing(statement, enable);
    }

    @Override
    public void statement_setFetchDirection(FilterChain chain, StatementProxy statement,
                                            int direction) throws SQLException {
        chain.statement_setFetchDirection(statement, direction);
    }

    @Override
    public void statement_setFetchSize(FilterChain chain, StatementProxy statement, int rows)
                                                                                             throws SQLException {
        chain.statement_setFetchSize(statement, rows);
    }

    @Override
    public void statement_setMaxFieldSize(FilterChain chain, StatementProxy statement, int max)
                                                                                               throws SQLException {
        chain.statement_setMaxFieldSize(statement, max);
    }

    @Override
    public void statement_setMaxRows(FilterChain chain, StatementProxy statement, int max)
                                                                                          throws SQLException {
    ...
    @Override
    public String clob_getSubString(FilterChain chain, ClobProxy wrapper, long pos, int length)
                                                                                               throws SQLException {
        return chain.clob_getSubString(wrapper, pos, length);
    }

    @Override
    public java.io.Reader clob_getCharacterStream(FilterChain chain, ClobProxy wrapper)
                                                                                       throws SQLException {
        return chain.clob_getCharacterStream(wrapper);
    }

    @Override
    public java.io.InputStream clob_getAsciiStream(FilterChain chain, ClobProxy wrapper)
                                                                                        throws SQLException {
        return chain.clob_getAsciiStream(wrapper);
    }

    @Override
    public long clob_position(FilterChain chain, ClobProxy wrapper, String searchstr, long start)
                                                                                                 throws SQLException {
        return chain.clob_position(wrapper, searchstr, start);
    }

    @Override
    public long clob_position(FilterChain chain, ClobProxy wrapper, Clob searchstr, long start)
                                                                                               throws SQLException {
        return chain.clob_position(wrapper, searchstr, start);
    }

    @Override
    public int clob_setString(FilterChain chain, ClobProxy wrapper, long pos, String str)
                                                                                         throws SQLException {
    ...
    @Override
    public java.io.OutputStream clob_setAsciiStream(FilterChain chain, ClobProxy wrapper, long pos)
                                                                                                   throws SQLException {
        return chain.clob_setAsciiStream(wrapper, pos);
    }

    @Override
    public java.io.Writer clob_setCharacterStream(FilterChain chain, ClobProxy wrapper, long pos)
                                                                                                 throws SQLException {
    ...
    @Override
    public Reader clob_getCharacterStream(FilterChain chain, ClobProxy wrapper, long pos,
                                          long length) throws SQLException {
    ...
    @Override
    public void dataSource_releaseConnection(FilterChain chain, DruidPooledConnection connection)
                                                                                                 throws SQLException {
    ...
    @Override
    public int resultSetMetaData_getColumnCount(FilterChain chain, ResultSetMetaDataProxy metaData)
                                                                                                   throws SQLException {
        return chain.resultSetMetaData_getColumnCount(metaData);
    }

    @Override
    public boolean resultSetMetaData_isAutoIncrement(FilterChain chain,
                                                     ResultSetMetaDataProxy metaData, int column)
                                                                                                 throws SQLException {
        return chain.resultSetMetaData_isAutoIncrement(metaData, column);
    }

    @Override
    public boolean resultSetMetaData_isCaseSensitive(FilterChain chain,
                                                     ResultSetMetaDataProxy metaData, int column)
                                                                                                 throws SQLException {
    ...
    @Override
    public boolean resultSetMetaData_isSearchable(FilterChain chain,
                                                  ResultSetMetaDataProxy metaData, int column)
                                                                                              throws SQLException {
    ...
    @Override
    public boolean resultSetMetaData_isCurrency(FilterChain chain, ResultSetMetaDataProxy metaData,
                                                int column) throws SQLException {
        return chain.resultSetMetaData_isCurrency(metaData, column);
    }

    @Override
    public int resultSetMetaData_isNullable(FilterChain chain, ResultSetMetaDataProxy metaData,
                                            int column) throws SQLException {
        return chain.resultSetMetaData_isNullable(metaData, column);
    }

    @Override
    public boolean resultSetMetaData_isSigned(FilterChain chain, ResultSetMetaDataProxy metaData,
                                              int column) throws SQLException {
        return chain.resultSetMetaData_isSigned(metaData, column);
    }

    @Override
    public int resultSetMetaData_getColumnDisplaySize(FilterChain chain,
                                                      ResultSetMetaDataProxy metaData, int column)
                                                                                                  throws SQLException {
    ...
    @Override
    public String resultSetMetaData_getColumnLabel(FilterChain chain,
                                                   ResultSetMetaDataProxy metaData, int column)
                                                                                               throws SQLException {
    ...
    @Override
    public String resultSetMetaData_getColumnName(FilterChain chain,
                                                  ResultSetMetaDataProxy metaData, int column)
                                                                                              throws SQLException {
    ...
    @Override
    public String resultSetMetaData_getSchemaName(FilterChain chain,
                                                  ResultSetMetaDataProxy metaData, int column)
                                                                                              throws SQLException {
    ...
    @Override
    public int resultSetMetaData_getPrecision(FilterChain chain, ResultSetMetaDataProxy metaData,
                                              int column) throws SQLException {
        return chain.resultSetMetaData_getPrecision(metaData, column);
    }

    @Override
    public int resultSetMetaData_getScale(FilterChain chain, ResultSetMetaDataProxy metaData,
                                          int column) throws SQLException {
        return chain.resultSetMetaData_getScale(metaData, column);
    }

    @Override
    public String resultSetMetaData_getTableName(FilterChain chain,
                                                 ResultSetMetaDataProxy metaData, int column)
                                                                                             throws SQLException {
    ...
    @Override
    public String resultSetMetaData_getCatalogName(FilterChain chain,
                                                   ResultSetMetaDataProxy metaData, int column)
                                                                                               throws SQLException {
    ...
    @Override
    public int resultSetMetaData_getColumnType(FilterChain chain, ResultSetMetaDataProxy metaData,
                                               int column) throws SQLException {
        return chain.resultSetMetaData_getColumnType(metaData, column);
    }

    @Override
    public String resultSetMetaData_getColumnTypeName(FilterChain chain,
                                                      ResultSetMetaDataProxy metaData, int column)
                                                                                                  throws SQLException {
    ...
    @Override
    public boolean resultSetMetaData_isReadOnly(FilterChain chain, ResultSetMetaDataProxy metaData,
                                                int column) throws SQLException {
        return chain.resultSetMetaData_isReadOnly(metaData, column);
    }

    @Override
    public boolean resultSetMetaData_isWritable(FilterChain chain, ResultSetMetaDataProxy metaData,
                                                int column) throws SQLException {
    ...
    @Override
    public String resultSetMetaData_getColumnClassName(FilterChain chain,
                                                       ResultSetMetaDataProxy metaData, int column)
                                                                                                   throws SQLException {
