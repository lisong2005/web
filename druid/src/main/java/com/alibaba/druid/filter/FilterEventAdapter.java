...
public abstract class FilterEventAdapter extends FilterAdapter {
    ...
    public PreparedStatementProxy connection_prepareStatement(FilterChain chain,
                                                              ConnectionProxy connection, String sql)
                                                                                                     throws SQLException {
        PreparedStatementProxy statement = super
            .connection_prepareStatement(chain, connection, sql);
    ...
    public PreparedStatementProxy connection_prepareStatement(FilterChain chain,
                                                              ...
                                                              String sql, int autoGeneratedKeys)
                                                                                                throws SQLException {
        PreparedStatementProxy statement = super.connection_prepareStatement(chain, connection,
