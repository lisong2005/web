...
public abstract class LogFilter extends FilterEventAdapter implements LogFilterMBean {
    ...
    public Savepoint connection_setSavepoint(FilterChain chain, ConnectionProxy connection)
        ...
        if (isConnectionLogEnabled()) {
            connectionLog("{conn " + connection.getId() + "} setSavepoint-"
    ...
    protected void statementExecuteAfter(StatementProxy statement, String sql, boolean firstResult) {
        ...
        if (statementExecuteAfterLogEnable && isStatementLogEnabled()) {
            ...
            statementLog("{conn-" + statement.getConnectionProxy().getId() + ", "
                         + stmtId(statement) + "} executed. " + millis + " millis. \n" + sql);
        }
    }
    ...
    protected void statementExecuteBatchAfter(StatementProxy statement, int[] result) {
        ...
        if (statementExecuteBatchAfterLogEnable && isStatementLogEnabled()) {
            ...
            statementLog("{conn-" + statement.getConnectionProxy().getId() + ", "
                         + stmtId(statement) + "} batch executed. " + millis + " millis. \n" + sql);
        }
    }
    ...
    protected void statementExecuteQueryAfter(StatementProxy statement, String sql,
        ...
        if (statementExecuteQueryAfterLogEnable && isStatementLogEnabled()) {
            ...
            statementLog("{conn-" + statement.getConnectionProxy().getId() + ", "
                         + stmtId(statement) + ", rs-" + resultSet.getId() + "} query executed. "
                         + millis + " millis. \n" + sql);
        }
    }
    ...
    protected void statementExecuteUpdateAfter(StatementProxy statement, String sql, int updateCount) {
        ...
        if (statementExecuteUpdateAfterLogEnable && isStatementLogEnabled()) {
            ...
            statementLog("{conn-" + statement.getConnectionProxy().getId() + ", "
                         + stmtId(statement) + "} update executed. effort " + updateCount + ". "
                         + millis + " millis. \n" + sql);
        }
    }
    ...
    protected void statementCreateAfter(StatementProxy statement) {
        if (statementCreateAfterLogEnable && isStatementLogEnabled()) {
            statementLog("{conn-" + statement.getConnectionProxy().getId() + ", stmt-"
                         + statement.getId() + "} created");
        }
    }
    ...
    protected void statementPrepareAfter(PreparedStatementProxy statement) {
        if (statementPrepareAfterLogEnable && isStatementLogEnabled()) {
            statementLog("{conn-" + statement.getConnectionProxy().getId() + ", pstmt-"
                         + statement.getId() + "} created. \n" + statement.getSql());
        }
    }
    ...
    protected void statementPrepareCallAfter(CallableStatementProxy statement) {
        if (statementPrepareCallAfterLogEnable && isStatementLogEnabled()) {
            statementLog("{conn-" + statement.getConnectionProxy().getId() + ", cstmt-"
                         + statement.getId() + "} created. \n" + statement.getSql());
        }
    }
    ...
    protected void statement_executeErrorAfter(StatementProxy statement, String sql, Throwable error) {
        if (this.isStatementLogErrorEnabled()) {
            statementLogError("{conn-" + statement.getConnectionProxy().getId() + ", "
                              + stmtId(statement) + "} execute error. " + sql, error);
        }
    }
    ...
    public void dataSource_releaseConnection(FilterChain chain, DruidPooledConnection conn)
        ...
        if (conn.getConnectionHolder() != null) {
            ConnectionProxy connection = (ConnectionProxy) conn.getConnectionHolder()
                .getConnection();
    ...
    public void preparedStatement_clearParameters(FilterChain chain,
        ...
        if (isStatementParameterClearLogEnable()) {
            statementLog("{conn-" + statement.getConnectionProxy().getId() + ", pstmt-"
                         + statement.getId() + "} clearParameters. ");
        }
