...
public class OracleUtils {
    ...
    public static OraclePreparedStatement unwrapInternal(PreparedStatement stmt)
                                                                                throws SQLException {
    ...
    public static void setImplicitCachingEnabled(Connection conn, boolean cache)
                                                                                throws SQLException {
        OracleConnection oracleConn = unwrap(conn);
    ...
    public static void openProxySession(Connection conn, int type, java.util.Properties prop)
                                                                                             throws SQLException {
        OracleConnection oracleConn = unwrap(conn);
