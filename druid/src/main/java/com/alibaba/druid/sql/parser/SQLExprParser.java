...
public class SQLExprParser extends SQLParser {
    ...
    public final static String[] AGGREGATE_FUNCTIONS = { "AVG", "COUNT", "MAX", "MIN", "STDDEV",
            "SUM"                                   };
            ...
            case SUB:
                ...
                switch (lexer.token()) {
                    ...
                    case IDENTIFIER: // 当负号后面为字段的情况
                        ...
                        break;
                    case QUES:
                        sqlExpr = new SQLUnaryExpr(SQLUnaryOperator.Negative,
    ...
    public SQLExpr relationalRest(SQLExpr expr) {
        ...
        if (lexer.token() == Token.LT) {
            ...
            expr = new SQLBinaryOpExpr(expr, SQLBinaryOperator.LessThanOrEqualOrGreaterThan,
                rightExp, getDbType());
