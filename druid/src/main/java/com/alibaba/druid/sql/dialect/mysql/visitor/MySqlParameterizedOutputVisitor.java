...
public class MySqlParameterizedOutputVisitor extends MySqlOutputVisitor implements
    ...
    public boolean visit(SQLIdentifierExpr x) {
        ...
        if (computeSharding) {
            ...
            computeSharding = parent instanceof SQLExprTableSource
                              || parent instanceof SQLPropertyExpr;
        }
