...
public class SQLUtils {
    ...
    public static String toSQLString(List<SQLStatement> statementList, String dbType,
                                     List<Object> parameters, FormatOption option) {
        StringBuilder out = new StringBuilder();
    ...
    public static void addCondition(SQLStatement stmt, SQLBinaryOperator op, SQLExpr condition,
        ...
        if (stmt instanceof SQLSelectStatement) {
            ...
            if (query instanceof SQLSelectQueryBlock) {
                ...
                throw new IllegalArgumentException("add condition not support "
    ...
    public static void addSelectItem(SQLStatement stmt, SQLExpr expr, String alias, boolean first) {
        ...
        throw new IllegalArgumentException("add selectItem not support "
                                           + stmt.getClass().getName());
    }
