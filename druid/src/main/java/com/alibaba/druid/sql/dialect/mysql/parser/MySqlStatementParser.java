                ...
                if (lexer.token() == Token.DROP) {
                    ...
                    if (lexer.token() == Token.COLUMN) {
                        ...
                        if (lexer.token() == Token.PRIMARY) {
                            SQLPrimaryKey primaryKey = ((MySqlExprParser) this.exprParser)
                                .parsePrimaryKey();
                    ...
                    accept(Token.EQ);
                    stmt.getItems().add(
                        new MySqlAlterTableOption(AUTO_INCREMENT, lexer.integerValue()));
                    lexer.nextToken();
                    ...
                    stmt.getItems().add(
                        new MySqlAlterTableOption("COMMENT", '\'' + lexer.stringVal() + '\''));
                    lexer.nextToken();
                } else {
                    break;
                }
