...
public class DruidDataSourceStatManager implements DruidDataSourceStatManagerMBean {
    ...
    private final static Log                        LOG                            = LogFactory
                                                                                       .getLog(DruidDataSourceStatManager.class);
    ...
    static IdentityHashMap<Object, ObjectName> getInstances0() {
        ...
        IdentityHashMap<Object, ObjectName> instances = (IdentityHashMap<Object, ObjectName>) properties
            .get(SYS_PROP_INSTANCES);

        if (instances == null) {
            synchronized (properties) {
                instances = (IdentityHashMap<Object, ObjectName>) properties
                    .get(SYS_PROP_INSTANCES);
    ...
    public TabularData getDataSourceList() throws JMException {
        ...
        TabularType tabularType = new TabularType("DruidDataSourceStat", "DruidDataSourceStat",
            rowType, indexNames);
    ...
    public static CompositeType getDruidDataSourceCompositeType() throws JMException {
        ...
        COMPOSITE_TYPE = new CompositeType("DataSourceStatistic", "DataSource Statistic",
            indexNames, indexDescriptions, indexTypes);
