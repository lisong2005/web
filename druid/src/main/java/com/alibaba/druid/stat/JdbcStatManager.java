...
public final class JdbcStatManager implements JdbcStatManagerMBean {
    ...
    public static CompositeType getDataSourceCompositeType() throws JMException {
        ...
        String[] indexNames = {
                ...
                ,
                // 30 - 34
                "StatementLastErrorStackTrace", "StatementExecuteMillisTotal",
                "ConnectionConnectingCount", "StatementExecuteLastTime",
                "ResultSetCloseCount" //
                ,
                // 35 -39
                "ResultSetOpenCount", "ResultSetOpenningCount", "ResultSetOpenningMax",
                "ResultSetFetchRowCount", "ResultSetLastOpenTime" //
                ,
                // 40 - 44
                "ResultSetErrorCount", //
        ...
        COMPOSITE_TYPE = new CompositeType("DataSourceStatistic", "DataSource Statistic",
            indexNames, indexNames, indexTypes);
    ...
    public TabularData getDataSourceList() throws JMException {
        ...
        TabularType tabularType = new TabularType("DataSourceStat", "DataSourceStat", rowType,
            indexNames);
        TabularData data = new TabularDataSupport(tabularType);

        {
            final ConcurrentMap<String, DataSourceProxyImpl> dataSources = DruidDriver
                .getProxyDataSources();
        ...
        final Set<DruidDataSource> dataSources = DruidDataSourceStatManager
    ...
    public TabularData getSqlList() throws JMException {
        ...
        TabularType tabularType = new TabularType("SqlListStatistic", "SqlListStatistic", rowType,
            indexNames);
        TabularData data = new TabularDataSupport(tabularType);
    ...
    public TabularData getConnectionList() throws JMException {
        ...
        TabularType tabularType = new TabularType("ConnectionList", "ConnectionList", rowType,
            indexNames);
        TabularData data = new TabularDataSupport(tabularType);
        ...
        for (DataSourceProxyImpl dataSource : dataSources.values()) {
            ...
            ConcurrentMap<Long, JdbcConnectionStat.Entry> connections = dataSourceStat
                .getConnections();
