...
public class WebStatFilter extends AbstractWebStatImpl implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        StatHttpServletResponseWrapper responseWrapper = new StatHttpServletResponseWrapper(
            httpResponse);
...

        {
            ...
            if (param != null && param.trim().length() != 0) {
                ...
                if ("true".equals(param)) {
                    ...
                    LOG.error("WebStatFilter Parameter '" + PARAM_NAME_SESSION_STAT_ENABLE
                              + "' config error");
                }
            }
        }

        {
            ...
            if (param != null && param.trim().length() != 0) {
                ...
                if ("true".equals(param)) {
                    ...
                    LOG.error("WebStatFilter Parameter '" + PARAM_NAME_PROFILE_ENABLE
                              + "' config error");
                }
            }
        }
    ...
    public final static class StatHttpServletResponseWrapper extends HttpServletResponseWrapper
                                                                                               implements
                                                                                               HttpServletResponse {
