...
public class SqlMapExecutorWrapper implements SqlMapExecutor {
    ...
    public SqlMapExecutorWrapper(ExtendedSqlMapClient client, SqlMapExecutor executor) {
        ...
        this.clientImpl = client.getClass() == SqlMapClientImpl.class ? (SqlMapClientImpl) client
            : null;
        this.clientImplWrapper = clientImpl != null ? new SqlMapClientImplWrapper(clientImpl)
            : null;
    }
