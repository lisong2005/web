...
public class DruidSqlDetailFrame extends JFrame {
    ...
    private final static Log                         LOG                    = LogFactory
                                                                                .getLog(DruidSqlDetailFrame.class);
    ...
    private void init() {
        ...
        try {
            ArrayList<LinkedHashMap<String, Object>> data = TableDataProcessor
                .parseData(TableDataProcessor.getData(url, conn));
            if (data != null) {
                ...
                for (Iterator<Entry<String, Object>> it = contentEle.entrySet().iterator(); it
                    .hasNext();) {
     ...
     * @param data 当前表格的数据
     */
    private void addTable(JPanel contentPanel, String title,
