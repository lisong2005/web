...
public class GroupableTableHeaderUI extends BasicTableHeaderUI {
    ...
    public int getHeaderHeight() {
        ...
        for (int column = 0; column < columnModel.getColumnCount(); column++) {
            ...
            Enumeration<ColumnGroup> enumeration = ((GroupableTableHeader) header)
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            cellRect.y = 0;
            TableColumn aColumn = enumeration.nextElement();
            Enumeration<ColumnGroup> cGroups = ((GroupableTableHeader) header)
                .getColumnGroups(aColumn);
            if (cGroups != null) {
                int groupHeight = 0;
    ...
    private void paintCell(Graphics g, Rectangle cellRect, int columnIndex) {
        ...
        Component component = renderer.getTableCellRendererComponent(header.getTable(),
            headerValue, false, false, -1, columnIndex);
