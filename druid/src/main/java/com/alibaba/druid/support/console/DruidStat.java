...
public class DruidStat {
    ...
    public static void printDruidStat(Option option) throws Exception {
        ...
        if (option.printDataSourceData()) {
            List<Map<String, Object>> content = (List<Map<String, Object>>) invokeService(jmxConn,
                Option.DATA_SOURCE);
        ...
        if (option.printActiveConn()) {
            List<List<String>> content = (List<List<String>>) invokeService(jmxConn,
                Option.ACTIVE_CONN);
    ...
    @SuppressWarnings("all")
    public static Object invokeService(MBeanServerConnection jmxConn, int dataType)
                                                                                   throws Exception {
