...
public class ConnectionProxyImpl extends WrapperProxyImpl implements ConnectionProxy {
    ...
    public ConnectionProxyImpl(DataSourceProxy dataSource, Connection connection,
                               Properties properties, long id) {
        super(connection, id);
    ...
    public Statement createStatement(int resultSetType, //
        ...
        Statement stmt = chain
            .connection_createStatement(this, resultSetType, resultSetConcurrency);
        recycleFilterChain(chain);
        return stmt;
    }
    ...
    public Statement createStatement(int resultSetType, //
        ...
        FilterChainImpl chain = createChain();
        Statement stmt = chain.connection_createStatement(this, resultSetType,
    ...
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency)
                                                                                                 throws SQLException {
        FilterChainImpl chain = createChain();
        CallableStatement stmt = chain.connection_prepareCall(this, sql, resultSetType,
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType,
        ...
        FilterChainImpl chain = createChain();
        PreparedStatement stmt = chain.connection_prepareStatement(this, sql, resultSetType,
            resultSetConcurrency);
        recycleFilterChain(chain);
        return stmt;
    }
