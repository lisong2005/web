 ...
 */
public class PreparedStatementProxyImpl extends StatementProxyImpl implements
    ...
    public PreparedStatementProxyImpl(ConnectionProxy connection, PreparedStatement statement,
                                      String sql, long id) {
    ...
    public void setAsciiStream(int parameterIndex, InputStream x, int length) throws SQLException {
        setParameter(parameterIndex,
            createParameter(JdbcParameter.TYPE.AsciiInputStream, x, length));
    ...
    public void setBinaryStream(int parameterIndex, InputStream x, int length) throws SQLException {
        setParameter(parameterIndex,
            createParameter(JdbcParameter.TYPE.BinaryInputStream, x, length));
    ...
    private void setObjectParameter(int parameterIndex, Object x) {
        ...
        if (x instanceof InputStream) {
            setParameter(parameterIndex, new JdbcParameterImpl(
                JdbcParameter.TYPE.BinaryInputStream, x));
            return;
        }

        if (x instanceof Reader) {
            setParameter(parameterIndex, new JdbcParameterImpl(
                JdbcParameter.TYPE.CharacterInputStream, x));
            return;
        }
