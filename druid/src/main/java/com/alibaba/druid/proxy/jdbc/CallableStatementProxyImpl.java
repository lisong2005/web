 ...
 */
public class CallableStatementProxyImpl extends PreparedStatementProxyImpl implements
                                                                          CallableStatementProxy {

    private final CallableStatement statement;

    public CallableStatementProxyImpl(ConnectionProxy connection, CallableStatement statement,
                                      String sql, long id) {
    ...
    public void registerOutParameter(String parameterName, int sqlType, String typeName)
                                                                                        throws SQLException {
        createChain()
            .callableStatement_registerOutParameter(this, parameterName, sqlType, typeName);
    }
