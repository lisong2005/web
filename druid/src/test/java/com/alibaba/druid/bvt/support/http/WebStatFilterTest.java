...
public class WebStatFilterTest extends TestCase {
    ...
    public void test_sessionStatDisable() throws Exception {
        ...
        Assert.assertTrue(StatFilterContext.getInstance().getListeners()
            .contains(filter.getStatFilterContextListener()));
        ...
        Assert.assertFalse(StatFilterContext.getInstance().getListeners()
            .contains(filter.getStatFilterContextListener()));
