...
public class DALParserTest extends TestCase {
    ...
    public void testSetTxn_0() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlSetTransactionStatement set = (MySqlSetTransactionStatement) parser
    ...
    public void test_setCharSet() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlSetCharSetStatement set = (MySqlSetCharSetStatement) parser.parseStatementList()
            .get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(set);
    ...
    public void test_show_authors() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowAuthorsStatement show = (MySqlShowAuthorsStatement) parser.parseStatementList()
            .get(0);
        parser.match(Token.EOF);
    ...
    public void test_show_binaryLogs() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowBinaryLogsStatement show = (MySqlShowBinaryLogsStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_masterLogs() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowMasterLogsStatement show = (MySqlShowMasterLogsStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_collation() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowCollationStatement show = (MySqlShowCollationStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_binaryLog() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowBinLogEventsStatement show = (MySqlShowBinLogEventsStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_character_set() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowCharacterSetStatement show = (MySqlShowCharacterSetStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_columns() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowColumnsStatement show = (MySqlShowColumnsStatement) parser.parseStatementList()
            .get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_contributors() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowContributorsStatement show = (MySqlShowContributorsStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_create_database() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowCreateDatabaseStatement show = (MySqlShowCreateDatabaseStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_create_event() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowCreateEventStatement show = (MySqlShowCreateEventStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_create_function() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowCreateFunctionStatement show = (MySqlShowCreateFunctionStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_create_PROCEDURE() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowCreateProcedureStatement show = (MySqlShowCreateProcedureStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_create_table() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowCreateTableStatement show = (MySqlShowCreateTableStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_create_trigger() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowCreateTriggerStatement show = (MySqlShowCreateTriggerStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_create_view() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowCreateViewStatement show = (MySqlShowCreateViewStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_databases() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowDatabasesStatement show = (MySqlShowDatabasesStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_engine() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowEngineStatement show = (MySqlShowEngineStatement) parser.parseStatementList().get(
            0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_engines() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowEnginesStatement show = (MySqlShowEnginesStatement) parser.parseStatementList()
            .get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_errors() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowErrorsStatement show = (MySqlShowErrorsStatement) parser.parseStatementList().get(
            0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_events() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowEventsStatement show = (MySqlShowEventsStatement) parser.parseStatementList().get(
            0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_function_code() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowFunctionCodeStatement show = (MySqlShowFunctionCodeStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_function_status() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowFunctionStatusStatement show = (MySqlShowFunctionStatusStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_grants() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowGrantsStatement show = (MySqlShowGrantsStatement) parser.parseStatementList().get(
            0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_index() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowIndexesStatement show = (MySqlShowIndexesStatement) parser.parseStatementList()
            .get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_master_status() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowMasterStatusStatement show = (MySqlShowMasterStatusStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_open_tables() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowOpenTablesStatement show = (MySqlShowOpenTablesStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_open_plugins() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowPluginsStatement show = (MySqlShowPluginsStatement) parser.parseStatementList()
            .get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_PRIVILEGES() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowPrivilegesStatement show = (MySqlShowPrivilegesStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_procedure_code() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowProcedureCodeStatement show = (MySqlShowProcedureCodeStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_procedure_status() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowProcedureStatusStatement show = (MySqlShowProcedureStatusStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_processList() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowProcessListStatement show = (MySqlShowProcessListStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_profiles() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowProfilesStatement show = (MySqlShowProfilesStatement) parser.parseStatementList()
            .get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_profile() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowProfileStatement show = (MySqlShowProfileStatement) parser.parseStatementList()
            .get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_profile_1() throws Exception {
        ...
        Assert
            .assertEquals(
                "SHOW PROFILE ALL, BLOCK IO, CONTEXT SWITCHES, CPU, IPC, MEMORY, PAGE FAULTS, SOURCE, SWAPS FOR QUERY 2 LIMIT 2, 1",
                output);
    }
    ...
    public void test_show_relayLogEvents() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowRelayLogEventsStatement show = (MySqlShowRelayLogEventsStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_slaveHosts() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowSlaveHostsStatement show = (MySqlShowSlaveHostsStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_slaveStatus() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowSlaveStatusStatement show = (MySqlShowSlaveStatusStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_status() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowStatusStatement show = (MySqlShowStatusStatement) parser.parseStatementList().get(
            0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_table_status() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowTableStatusStatement show = (MySqlShowTableStatusStatement) parser
            .parseStatementList().get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_triggers() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowTriggersStatement show = (MySqlShowTriggersStatement) parser.parseStatementList()
            .get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
    ...
    public void test_show_variants() throws Exception {
        ...
        MySqlStatementParser parser = new MySqlStatementParser(sql);
        MySqlShowVariantsStatement show = (MySqlShowVariantsStatement) parser.parseStatementList()
            .get(0);
        parser.match(Token.EOF);
        String output = SQLUtils.toMySqlString(show);
