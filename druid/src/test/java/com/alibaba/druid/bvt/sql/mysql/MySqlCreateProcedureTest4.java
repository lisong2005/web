...
public class MySqlCreateProcedureTest4 extends MysqlTest {
    ...
    public void test_0() throws Exception {
        String sql = "create or replace procedure sp_name(level int,age int)" + " begin"
                     + " declare x,y,z int;" + " repeat" + " insert into test values(id,age);"
                     + " until x>10" + " end repeat;" + " end";
    ...
    public void test_1() throws Exception {
        String sql = "create or replace procedure sp_name(level int,age int)" + " begin"
                     + " declare x,y,z int;" + " lable_1: repeat"
                     + " insert into test values(id,age);" + " until x>10" + " end repeat lable_1;"
                     + " end";
