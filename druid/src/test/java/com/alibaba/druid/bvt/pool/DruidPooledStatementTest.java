...
public class DruidPooledStatementTest extends TestCase {
    ...
    private final class ErrorFilter extends FilterAdapter {
        ...
        @Override
        public void statement_setQueryTimeout(FilterChain chain, StatementProxy statement,
                                              int seconds) throws SQLException {
            throw new SQLException();
        }

        @Override
        public void statement_cancel(FilterChain chain, StatementProxy statement)
                                                                                 throws SQLException {
            throw new SQLException();
        }
        ...
        @Override
        public void statement_setFetchSize(FilterChain chain, StatementProxy statement, int value)
                                                                                                  throws SQLException {
            throw new SQLException();
        }
