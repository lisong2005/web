...
public class PSCacheTest3 extends TestCase {
    ...
    public void test_pscache() throws Exception {
        ...
        // sql_0连续执行两次
        {
            DruidPooledPreparedStatement stmt_0 = (DruidPooledPreparedStatement) conn
                .prepareStatement(sql_0);
        ...
        {
            DruidPooledPreparedStatement stmt_1 = (DruidPooledPreparedStatement) conn
                .prepareStatement(sql_1);
            Assert.assertEquals(1, stmtPool.size());
        ...
        {
            DruidPooledPreparedStatement stmt_2 = (DruidPooledPreparedStatement) conn
                .prepareStatement(sql_2);
            Assert.assertEquals(2, stmtPool.size());
        ...
        {
            DruidPooledPreparedStatement stmt_3 = (DruidPooledPreparedStatement) conn
                .prepareStatement(sql_3);
            Assert.assertEquals(3, stmtPool.size());
        ...
        {
            DruidPooledPreparedStatement stmt_4 = (DruidPooledPreparedStatement) conn
                .prepareStatement(sql_4);
            Assert.assertEquals(3, stmtPool.size());
