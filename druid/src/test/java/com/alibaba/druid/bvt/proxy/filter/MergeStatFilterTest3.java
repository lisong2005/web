...
public class MergeStatFilterTest3 extends TestCase {
    ...
    public void test_merge() throws Exception {
        String sqllist = Utils.read(new InputStreamReader(this.getClass().getResourceAsStream(
            "/bvt/parser/postgresql.txt")));
        ...
        System.out.println(dataSource.getDataSourceStat().getSqlStatMap().keySet().iterator()
            .next());
