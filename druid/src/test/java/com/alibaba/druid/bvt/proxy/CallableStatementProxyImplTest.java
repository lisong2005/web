...
public class CallableStatementProxyImplTest extends TestCase {
    ...
    public void test_call() throws Exception {
        ...
        String sql = "CALL P_0(?, ?)";
        CallableStatementProxyImpl rawCallStatement = new FakeCallableStatement(
            new ConnectionProxyImpl(null, null, null, 0), null, sql, 1001);

        ConnectionProxy connection = new ConnectionProxyImpl(dataSource, null, new Properties(),
            1001);
        CallableStatementProxyImpl cstmt = new CallableStatementProxyImpl(connection,
            rawCallStatement, sql, 2001);
    ...
    private static final class FakeCallableStatement extends CallableStatementProxyImpl {
        ...
        private FakeCallableStatement(ConnectionProxy connection, CallableStatement statement,
                                      String sql, long id) {
        ...
        @Override
        public void registerOutParameter(String parameterIndex, int sqlType, String typeName)
                                                                                             throws SQLException {
        ...
        @Override
        public void registerOutParameter(String parameterIndex, int sqlType, int scale)
                                                                                       throws SQLException {
