...
public class MonitorDaoJdbcImplTest extends TestCase {
    ...
    public void testBuildSql() throws Exception {
        ...
        {
            List<JdbcSqlStatValue> sqlList = client.loadSqlList(Collections
    ...
    public String buildCreateSql(MonitorDaoJdbcImpl dao, BeanInfo beanInfo) {
        ...
        for (int i = 0; i < fields.size(); ++i) {
            ...
            if (field.getFieldType().equals(int.class)
                || field.getFieldType().equals(Integer.class)) {
                buf.append(" int(10)");
                ...
                buf.append(" datetime");
                       ...
                       || field.getFieldType().equals(Boolean.class)) {
                buf.append(" int(1)");
            }
        }
