...
public class WallPerformanceTest_1 extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        for (int i = 0; i < 1000; i++) {
            provider
                .checkValid("select sum(payment_ft) from order_goods where order_id=1 AND (SELECT 4552 FROM(SELECT COUNT(*),CONCAT(CHAR(58,107,98,119,58),(SELECT (CASE WHEN (4552=4552) THEN 1 ELSE 0 END)),CHAR(58,98,105,101,58),FLOOR(RAND(0)*2))x FROM information_schema.tables GROUP BY x)a)");
        }
    }
