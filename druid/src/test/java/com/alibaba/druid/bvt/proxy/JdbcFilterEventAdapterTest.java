...
public class JdbcFilterEventAdapterTest extends TestCase {
    ...
    public void test_filterEventAdapter() throws Exception {
        ...
        ConnectionProxy connection = new ConnectionProxyImpl(dataSource, null, new Properties(),
            1001);
        final PreparedStatementProxy statement = new PreparedStatementProxyImpl(connection, null,
            sql, 1002);
...

        {
            FilterChain chain = new FilterChainImpl(new DataSourceProxyImpl(null, config)) {
                ...
                public int statement_executeUpdate(StatementProxy statement, String sql)
                                                                                        throws SQLException {
                    throw new SQLException();
                }
            };
