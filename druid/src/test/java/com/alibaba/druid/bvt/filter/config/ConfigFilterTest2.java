...
public class ConfigFilterTest2 extends TestCase {
    ...
    public void test_decrypt() throws Exception {
        dataSource
            .addConnectionProperty(ConfigFilter.CONFIG_FILE, "bvt/config/config-0.properties");
    ...
    public void test_decrypt1() throws Exception {
        dataSource
            .addConnectionProperty(ConfigFilter.CONFIG_FILE, "bvt/config/config-1.properties");
        Assert.assertEquals(1, dataSource.getProxyFilters().size());
    ...
    public void test_decrypt2() throws Exception {
        dataSource
            .addConnectionProperty(ConfigFilter.CONFIG_FILE, "bvt/config/config-2.properties");
    ...
    public void test_decrypt3() throws Exception {
        dataSource
            .addConnectionProperty(ConfigFilter.CONFIG_FILE, "bvt/config/config-3.properties");
        Assert.assertEquals(1, dataSource.getProxyFilters().size());
    ...
    public void test_decrypt4() throws Exception {
        String file = Thread.currentThread().getContextClassLoader()
            .getResource("bvt/config/config-3.properties").getFile();
    ...
    public void test_decrypt5() throws Exception {
        ...
        try {
            String file = Thread.currentThread().getContextClassLoader()
                .getResource("bvt/config/config-2.properties").getFile();
