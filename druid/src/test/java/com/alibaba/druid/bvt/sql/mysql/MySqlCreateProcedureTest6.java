...
public class MySqlCreateProcedureTest6 extends MysqlTest {
    ...
    public void test_0() throws Exception {
        String sql = "create or replace procedure sp_name(level int,age int)" + " begin"
                     + " insert into test values(id,age);" + " end";
    ...
    public void test_1() throws Exception {
        String sql = "create or replace procedure sp_name(in level int,in age int)" + " begin"
                     + " insert into test values(id,age);" + " end";
    ...
    public void test_2() throws Exception {
        String sql = "create or replace procedure sp_name(out level int,out age int)" + " begin"
                     + " insert into test values(id,age);" + " end";
    ...
    public void test_3() throws Exception {
        String sql = "create or replace procedure sp_name(inout level int,inout age int)"
                     + " begin" + " insert into test values(id,age);" + " end";
