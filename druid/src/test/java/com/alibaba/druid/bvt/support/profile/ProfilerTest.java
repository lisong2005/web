...
public class ProfilerTest extends TestCase {
    ...
    private void req() {
        ...
        {
            ProfileEntryReqStat stat = Profiler.getStatsMap().get(
                new ProfileEntryKey("/", "com.xxx.a(int)", Profiler.PROFILE_TYPE_SPRING));
        ...
        {
            ProfileEntryReqStat stat = Profiler.getStatsMap().get(
                new ProfileEntryKey("com.xxx.a(int)", "com.xxx.b(int)",
