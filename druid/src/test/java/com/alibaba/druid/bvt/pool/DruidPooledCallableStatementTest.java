...
public class DruidPooledCallableStatementTest extends TestCase {
    ...
    public void test_getObject() throws Exception {
        Connection conn = dataSource.getConnection();
        DruidPooledCallableStatement stmt = (DruidPooledCallableStatement) conn
            .prepareCall("select 1");
        stmt.execute();
    ...
    public void test_wrap() throws Exception {
        ...
        Assert.assertEquals(MockCallableStatement.class, stmt.unwrap(CallableStatement.class)
            .getClass());
