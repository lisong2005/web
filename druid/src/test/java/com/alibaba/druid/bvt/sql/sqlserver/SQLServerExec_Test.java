...
public class SQLServerExec_Test extends TestCase {
    ...
    public void test_0() throws Exception {
        ...
        Assert.assertEquals("EXEC sp_rename 'rules.temp_plugin_config_key', 'plugin_config_key'",
            output);
    ...
    public void test_2() throws Exception {
        ...
        String output = SQLUtils.toSQLString(stmt, JdbcConstants.SQL_SERVER);
        Assert.assertEquals("EXEC @returnstatus = dbo.ufnGetSalesOrderStatusText @Status = 2",
            output);
