...
public class SQLServerWallPermitObjectTest extends TestCase {
    ...
    public void test_user2() throws Exception {
        Assert.assertFalse(WallUtils
            .isValidateSqlServer("SELECT id from T where 1=1 and 1!=1 union select user;"));
    }
    ...
    public void test_system_user2() throws Exception {
        Assert.assertFalse(WallUtils
            .isValidateSqlServer("SELECT id from T where 1=1 and 1!=1 union select system_user;"));
    }
}
