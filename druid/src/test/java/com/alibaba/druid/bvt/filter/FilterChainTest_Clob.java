...
public class FilterChainTest_Clob extends TestCase {
    ...
    public void test_resultSet_getClob() throws Exception {
        ...
        Clob clob = chain.resultSet_getClob(new ResultSetProxyImpl(statement, mockResultSet, 1,
            null), 1);
    ...
    public void test_resultSet_getObject() throws Exception {
        ...
        Clob clob = (Clob) chain.resultSet_getObject(new ResultSetProxyImpl(statement,
            mockResultSet, 1, null), 1);
    ...
    public void test_resultSet_getObject_2() throws Exception {
        ...
        Clob clob = (Clob) chain.resultSet_getObject(new ResultSetProxyImpl(statement,
            mockResultSet, 1, null), 1, Collections.<String, Class<?>> emptyMap());
