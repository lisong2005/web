...
public class DruidLoaderUtilsTest extends TestCase {
    ...
    public void testLoadFilter() throws SQLException {
        ...
        Assert.assertEquals("com.alibaba.druid.filter.logging.Log4jFilter", filterConfig.getClass()
            .getName());
        // stat
        filterItem = "stat";
        filters.clear();
        ...
        Assert.assertNotNull(filterConfig);
        Assert.assertEquals("com.alibaba.druid.filter.stat.StatFilter", filterConfig.getClass()
            .getName());
        // default
        filterItem = "default";
        filters.clear();
        ...
        filterConfig = filters.get(0);
        Assert.assertNotNull(filterConfig);
        Assert.assertEquals("com.alibaba.druid.filter.logging.CommonsLogFilter", filterConfig
            .getClass().getName());
        // encoding
        filterItem = "encoding";
        filters.clear();
        ...
        filterConfig = filters.get(0);
        Assert.assertNotNull(filterConfig);
        Assert.assertEquals("com.alibaba.druid.filter.encoding.EncodingConvertFilter", filterConfig
            .getClass().getName());
        // 判定重复
        filterItem = "stat";
        filters.clear();
