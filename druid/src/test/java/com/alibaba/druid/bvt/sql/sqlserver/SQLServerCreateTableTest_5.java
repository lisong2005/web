...
public class SQLServerCreateTableTest_5 extends TestCase {
    ...
    public void test_0() throws Exception {
        ...
        Assert.assertTrue(visitor.getTables().containsKey(
            new TableStat.Name("dbo.AO_563AEE_ACTOR_ENTITY")));

        Assert.assertTrue(visitor.getColumns().contains(
            new Column("dbo.AO_563AEE_ACTOR_ENTITY", "FULL_NAME")));
        Assert.assertTrue(visitor.getColumns().contains(
            new Column("dbo.AO_563AEE_ACTOR_ENTITY", "ID")));
        Assert.assertTrue(visitor.getColumns().contains(
            new Column("dbo.AO_563AEE_ACTOR_ENTITY", "USERNAME")));
    }
}
