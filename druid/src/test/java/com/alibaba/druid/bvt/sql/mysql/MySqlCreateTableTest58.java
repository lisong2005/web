...
public class MySqlCreateTableTest58 extends MysqlTest {
    ...
    public void test_one() throws Exception {
        String sql = "CREATE TABLE `appservice_account` ("
                     ...
                     + "`name` varchar(50) NOT NULL," + "`gender` integer,"
                     + "`uploadVideoCount` integer NOT NULL," + "`fansCount` integer NOT NULL,"
                     + "`balance` numeric(19, 2) NOT NULL," + "`brick` integer NOT NULL,"
                     + "`reward` integer NOT NULL," + "`token` varchar(500) NOT NULL,"
                     ...
                     + "`wechatAccesstoken` varchar(500) NOT NULL," + "`is_active` bool NOT NULL,"
