...
public class DruidDataSourceFactoryTest1 extends TestCase {
    ...
    public void test_NONE() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(Connection.TRANSACTION_NONE, dataSource
                .getDefaultTransactionIsolation().intValue());
    ...
    public void test_READ_COMMITTED() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals("jdbc:mock:xxx", dataSource.getUrl());
            Assert.assertEquals(Connection.TRANSACTION_READ_COMMITTED, dataSource
                .getDefaultTransactionIsolation().intValue());
    ...
    public void test_READ_UNCOMMITTED() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals("jdbc:mock:xxx", dataSource.getUrl());
            Assert.assertEquals(Connection.TRANSACTION_READ_UNCOMMITTED, dataSource
                .getDefaultTransactionIsolation().intValue());
    ...
    public void test_REPEATABLE_READ() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals("jdbc:mock:xxx", dataSource.getUrl());
            Assert.assertEquals(Connection.TRANSACTION_REPEATABLE_READ, dataSource
                .getDefaultTransactionIsolation().intValue());
    ...
    public void test_SERIALIZABLE() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals("jdbc:mock:xxx", dataSource.getUrl());
            Assert.assertEquals(Connection.TRANSACTION_SERIALIZABLE, dataSource
                .getDefaultTransactionIsolation().intValue());
    ...
    public void test_getObjectInstance_1() throws Exception {
        Assert.assertNull(new DruidDataSourceFactory().getObjectInstance(new Object(), null, null,
            null));
    }
}
