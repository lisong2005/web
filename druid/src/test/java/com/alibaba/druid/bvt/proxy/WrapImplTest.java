...
public class WrapImplTest extends TestCase {
    ...
    public void test_clone() throws Exception {
        ...
        ConnectionProxyImpl connection = (ConnectionProxyImpl) driver
        ...
        Assert.assertEquals("org.apache.derby.jdbc.EmbeddedDriver",
            dataSource.getRawDriverClassName());
        ...
        org.apache.derby.impl.jdbc.EmbedConnection derbyConnection = connection
            .unwrap(org.apache.derby.impl.jdbc.EmbedConnection.class);
        ...
        org.apache.derby.impl.jdbc.EmbedStatement rayStatement = statement
            .unwrap(org.apache.derby.impl.jdbc.EmbedStatement.class);
