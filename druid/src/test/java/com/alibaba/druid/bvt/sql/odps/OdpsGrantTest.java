...
public class OdpsGrantTest extends TestCase {
    ...
    public void test_0() throws Exception {
        ...
        Assert
            .assertEquals(
                "GRANT UPDATE, SELECT ON TABLE adl_register_baseline_sdt TO USER DXP_71074213@aliyun.com",
                output);
    }
    ...
    public void test_3() throws Exception {
        ...
        Assert
            .assertEquals(
                "GRANT LABEL 2 ON TABLE adl_register_baseline_sdt(c1, c2) TO USER aliyun$DXP_xxxxx@aliyun.com WITH EXP 5",
                output);
    }
