...
public class PreparedStatementKeyTest extends TestCase {
    ...
    public void test_0() throws Exception {
        PreparedStatementKey k1 = new PreparedStatementKey("select 'a'", "c1", MethodType.M1, 101,
            102, 103);
    ...
    public void test_eq() throws Exception {
        Assert.assertEquals(new PreparedStatementKey("select 'a'", "c1", MethodType.M1, 101, 102,
            103), new PreparedStatementKey("select 'a'", "c1", MethodType.M1, 101, 102, 103));
