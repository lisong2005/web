...
public class ConfigFilterTest3 extends TestCase {
    ...
    public void test_0() throws Exception {
        ...
        properties
            .put(DruidDataSourceFactory.PROP_PASSWORD, ConfigTools.encrypt(keys[0], password));
        ...
        dataSource.getConnectProperties().put(ConfigFilter.CONFIG_FILE,
    ...
    public void test_sys_property() throws Exception {
        ...
        System.getProperties().put(ConfigFilter.SYS_PROP_CONFIG_FILE,
            "file://" + file.getAbsolutePath());
