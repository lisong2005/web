...
public class SqlMapClientWrapperTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        context = new ClassPathXmlApplicationContext(
            "com/alibaba/druid/pool/ibatis/spring-config-ibatis-1.xml");
    ...
    public void test_wrap() throws Exception {
        ...
        Assert.assertEquals(1, wrapper.queryForList("User.select", Collections.emptyMap(), 0, 2)
            .size());
        ...
        Assert.assertEquals(1,
            wrapper.queryForPaginatedList("User.select", Collections.emptyMap(), 10).size());
