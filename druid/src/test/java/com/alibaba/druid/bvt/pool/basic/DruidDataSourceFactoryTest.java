...
public class DruidDataSourceFactoryTest extends TestCase {
    ...
    public void test_factory() throws Exception {
        ...
        Assert.assertNull(factory.getObjectInstance(new Reference("javax.sql.Date"), null, null,
            null));
    ...
    public void test_createDataSource() throws Exception {
        ...
        properties.setProperty("exceptionSorter",
            "com.alibaba.druid.pool.vendor.NullExceptionSorter");
        properties.setProperty("exception-sorter-class-name",
            "com.alibaba.druid.pool.vendor.NullExceptionSorter");
