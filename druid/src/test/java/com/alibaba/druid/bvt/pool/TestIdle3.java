...
public class TestIdle3 extends TestCase {
    ...
    public void test_idle2() throws Exception {
        ...
        ManagementFactory.getPlatformMBeanServer().registerMBean(dataSource,
            new ObjectName("com.alibaba:type=DataSource,name=mysql"));
        ManagementFactory.getPlatformMBeanServer().registerMBean(dataSource,
            new ObjectName("com.alibaba:type=DataSource,name=oracle"));
        ...
        Assert.assertEquals(true, dataSource.getPoolingCount() == 2
                                  || dataSource.getPoolingCount() == 1);
