...
public class JdbcUtilsTest extends TestCase {
    ...
    public void testGetDbType() {
        ...
        assertEquals("not support cobar driver, url like jdbc:cobar:...", JdbcConstants.MYSQL,
            dbType);
    }
    ...
    public void test_log4jdbc_mysql() {
        ...
        String dbType = JdbcUtils.getDbType(jdbcUrl, null);
        assertEquals("not support log4jdbc mysql, url like jdbc:log4jdbc:mysql:...",
            JdbcConstants.MYSQL, dbType);
    }
