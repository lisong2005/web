...
public class MapComparatorTest extends TestCase {
    ...
    private void test_comparator_array_0(boolean desc) throws Exception {
        ...
        MapComparator<String, Date[]> comparator = new MapComparator<String, Date[]>(orderByKey
                                                                                     + "[0]", desc);
    ...
    private void test_comparator_string_0(boolean desc) throws Exception {
        MapComparator<String, String> comparator = new MapComparator<String, String>(orderByKey,
            desc);
    ...
    private void test_comparator_number_0(boolean desc) throws Exception {
        MapComparator<String, Double> comparator = new MapComparator<String, Double>(orderByKey,
            desc);
